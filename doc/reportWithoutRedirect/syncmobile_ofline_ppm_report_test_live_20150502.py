...
def doc_info_submit():
    ...
    dName= check_special_char(dName)
    dSpaciality=  check_special_char(dSpaciality)
    dDegree= check_special_char(dDegree)
    dCAddress= check_special_char(dCAddress)
    dDist= check_special_char(dDist)
    dThana= check_special_char(dThana)
