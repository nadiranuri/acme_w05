...
function check_user() {	
	...
	//Nazma Azam 2020-01-05 end

	//var  apipath_base_photo_dm='http://w03.yeapps.com/skfonc/syncmobile_417_web_firm/dmpath?CID='+cid +'&HTTPPASS=e99business321cba'
...
localStorage.report_button='<span style="color:#dd5564; font-size:18px;">Sales Call and Order</span></br> <table width="100%" border="0"><tr><td width="49%"><input align="right" type="submit" id="loginButton" onClick="s_order_summary_report();"  style="width:100%; height:50px; background-color:#fce0e9; color:#dd5564; font-size:20px;border-radius:10px;" value="     Count     "   /></td><td width="2%">&nbsp;</td><td width="49%"><input align="left" type="submit" id="loginButton" onClick="s_order_detail_report();"  style="width:100%; height:50px; background-color:#fce0e9; color:#dd5564; font-size:20px;border-radius:10px;" value="     Detail     "   /></td></tr></table>'
...
localStorage.report_button_tr='<input type="submit" id="loginButton" onClick="s_order_summary_report_tr_next();"  style="width:100%; height:50px; background-color:#b3c6ff; color:#002080; font-size:20px;border-radius:10px;" value="    Order Summary     "   />'
//localStorage.report_button='<a data-role="button" onClick="s_order_detail_report();" >Sales Call and Order Report</a>'
										...
										if (localStorage.m_DCR=="YES"){
										//Nazma Azam 2020-01-05 start				
										localStorage.doctor_report_button='<span style="color:#A4D893; font-size:18px;">DCR</span></br><table width="100%" border="0"><tr><td width="49%"><input align="right" type="submit" id="loginButton" onClick="summary_report_doctor();"  style="width:100%; height:50px; background-color:#A4D893; color:#FFF; font-size:20px;border-radius:10px;" value="     Count     "   /></td><td width="2%">&nbsp;</td><td width="49%"><input type="submit" align="left" id="loginButton" onClick="detail_report_doctor();"  style="width:100%; height:50px; background-color:#A4D893; color:#FFF; font-size:20px;border-radius:10px;" value="     Detail     "   /></td></tr></table>'
										...
										localStorage.doctor_report_button_tr='<input type="submit" id="loginButton" onClick=" summary_report_doctor_tr_next();"  style="width:100%; height:50px; background-color:#ccd9ff; color:#002080; font-size:20px;border-radius:10px;" value="    DCR Summary     "   />'
											}
											//Nazma Azam 2020-01-05 end
					...
					//Nazma Azam 2020-01-05 start
  localStorage.prescription_report_button='<span style="color:#23bfc6; font-size:18px;">Prescription</span></br><table width="100%" border="0"><tr><td width="49%"><input align="right" type="submit" id="loginButton" onClick="summary_report_prescription();"  style="width:100%; height:50px; background-color:#c5f8f7; color:#23bfc6; font-size:20px;border-radius:10px; " value="    Count     "   /></td><td width="2%">&nbsp;</td><td width="49%"><input align="left" type="submit" id="loginButton" onClick="detail_report_prescription();"  style="width:100%; height:50px; background-color:#c5f8f7; color:#23bfc6; font-size:20px;border-radius:10px; " value="    Detail     "   /></td></tr></table>'	
...
//		localStorage.prescription_report_button=''}
	...
	localStorage.report_others_tr	='<input type="submit" id="loginButton" onClick="pay_tr_next ();"  style="width:100%; height:50px; background-color:#99b3ff; color:#FFF; font-size:20px;border-radius:10px;" value="   Pay Slip      "   /></br><input type="submit" id="loginButton" onClick="expense_tr_next();"  style="width:100%; height:50px; background-color:#809fff; color:#FFF; font-size:20px;border-radius:10px;" value="   Expense Slip     "   />'
...
function reports() {
	...
	//Nazma Azam 2020-01-05 start
		/*var str_report_rep='<table width="100%" border="0">'+
					 '<tr><td width="100px">ID: </td><td width="100px"><input id="se_mpo_doc" name="se_mpo_doc" type="text" readonly="true" placeholder="Rep" style="width:100px" >'+
					  '<input id="se_item_doc" name="se_item_doc" type="hidden" placeholder="Item"></td>'+
					   '<td width="100px">BaseCode: </td><td width="100px"><input id="se_market_doc" name="se_market_doc" type="text" placeholder="Market"  style="width:100px" ></td></tr></table>'
	var str_report_sup='<table width="100%" border="0">'+
					   '<tr><td width="100px">ID: </td><td><input id="se_mpo_doc" name="se_mpo_doc" type="text" placeholder="Rep" style="width:100px" >'+
					   '<input id="se_item_doc" name="se_item_doc" type="hidden" placeholder="Item"></td>	'+
					   '<td width="100px">BaseCode: </td><td width="100px"><input id="se_market_doc" name="se_market_doc" type="text" placeholder="Market/level"  style="width:100px" ></td></tr></table>'*/
