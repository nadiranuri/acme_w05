...
function tour_amnd(){
	...
	var linkPath1="window.open('"+localStorage.path_value_report+"teamShow_web?"+"cid="+localStorage.cid+"&rep_id="+localStorage.user_id+"&rep_pass="+localStorage.user_pass	+"&monthPass=Next', '_system');"
