...
function saveDelete_doc(i) {
	...
	for ( i=0; i < docSaveDataListLength-1; i++){	
		...
		//alert (singleDoc)
		//docSaveStr=docSaveStr+'<li  style=" border-radius:0px;border-bottom:1px solid #a5a9a9" > <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-radius:5px;"><tr><td onClick="saved_Doc_set(\''+i+'\');">'+docShowList[0]+'</td><td width="60px"><input  type="submit" onClick="saveDelete_doc(\''+i+'\');"   style=" background-color:#09C; color:#FFF; font-size:12px; width:50px; ;  " value=" OK "    /></td></tr></table></li>'
...
function check_user() {	
	...
	// var  apipath_base_photo_dm='http://127.0.0.1:8000/novivo/syncmobile_new_design/dmpath?CID='+cid +'&HTTPPASS=e99business321cba'
	
	var  apipath_base_photo_dm='http://w05.yeapps.com/novivo/syncmobile_new_design/dmpath?CID='+cid +'&HTTPPASS=e99business321cba'
...
//													}
													...
													for (var l=0; l < linkStrList.length; l++){
														...
														//alert (linkPath);
														if(path_value!=''){
															linkStr_combo+='<li style=" border-radius:0px;border-bottom:1px solid #a5a9a9"><table width="100%" border="0" id="order_tbl" cellpadding="0" cellspacing="0" style="border-radius:5px;"><tr><td><a href="#" style="color:#fff" onclick="'+linkPath+'">'+pathName+'</a></td></tr></table></li>';
...
//												alert (localStorage.menu_list);
										...
										//------------- Visit Plan Market List / Client Profile Market List / Unschedule
													...
													for (var k=0; k < planMarketListShowLength; k++){
														...
														//alert (marketNameID);
														if(planMarketID!=''){
															unscheduleMarketComb+='<li class="ui-btn ui-shadow ui-corner-all ui-btn-icon-left ui-icon-location" style=" border-radius:0px;border-bottom:1px solid #a5a9a9"><a onClick="marketNextLV(\''+marketNameID+'\')"><font class="name" style="font-size:18; font-weight:bold">'+marketNameID+'</a></font></li>';
															
															visitPlanMarketComb+='<li  style=" border-color:#CBE4E4;border-bottom-width:thin;height=15px" onClick="check_boxTourTrue(\''+marketID+'\')"> '+'<table width="100%" border="0" id="order_tbl" cellpadding="0" cellspacing="0" style="border-radius:5px;">'+'<tr style="border-radius:0px;border-bottom:1px solid #D2EEE9;"><td width="60px" style="text-align:center; padding-left:5px;"><input class="docCampaign" type="checkbox" onClick="getDocTour_keyup(\''+marketID+'\')" name="doc_tour'+marketID+'" value="checkbox" id="doc_tour'+marketID+'"><label for="doc_camp'+marketID+'"></br></label></td><td  style="text-align:left;">'+'</br><font id="'+ marketID +'" onClick="check_boxTourTrue(\''+marketID+'\')" class="name" >'+ marketNameID+'</font></td></tr>'+'</table>'+'</li>';
															
															profileMarketComb+='<li class="ui-btn ui-shadow ui-corner-all ui-btn-icon-left ui-icon-location" style=" border-color:#CBE4E4;border-bottom-width:thin;height:15px"><a onClick="marketNextCProfileLV(\''+marketNameID+'\')"><font class="name" style="font-size:12; font-weight:bold; color:#fff">'+marketNameID+'</font></a></li>';
															
															unscheduleMarketComb_tr+='<li class="ui-btn ui-shadow ui-corner-all ui-btn-icon-left ui-icon-location" style=" border-radius:0px;border-bottom:1px solid #a5a9a9"><a onClick="summary_report_doctor_tr(\''+marketNameID+'\')"><font class="name" style="font-size:18; font-weight:bold">'+marketNameID+'</a></font></li>';
										...
										//===========Market===========================
												//------------- Visit Plan Market List / Client Profile Market List / Unschedule
													...
													if ((docMarketDate!=CDate) &&(tomorrowFlag==0) && (docMarketDate.length > 5)) {
																docMarketComb+='<li class="ui-btn ui-shadow ui-corner-all ui-btn-icon-left ui-icon-location" style=" border-color:#CBE4E4;border-bottom-width:thin;background-color:#EDFBFE"><font  style="font-size:24; font-weight:bold;color:#009">Tomorrow</font></li>';
																tomorrowFlag=1
															}
															if ((docMarketDate==CDate) &&(todayFlag==0)) {
																docMarketComb+='<li class="ui-btn ui-shadow ui-corner-all ui-btn-icon-left ui-icon-location" style=" border-color:#CBE4E4;border-bottom-width:thin;background-color:#EDFBFE"><font  style="font-size:24; font-weight:bold;color:#009">Today</font></li>';
																todayFlag=1
															}
															if (docMarketID!=''){
																docMarketComb+='<li class="ui-btn ui-shadow ui-corner-all ui-btn-icon-left ui-icon-location" style=" border-radius:0px;border-bottom:1px solid #a5a9a9"><a onClick="setScheduleDateDoc(\''+docMarketDate+'\');marketNextLV(\''+docmarketNameID+'\');"><font class="name" style="font-size:18; font-weight:bold">'+docMarketName+'</a></font></li>';
															//alert (docMarketComb)	
																}
														}
...
//													$('#tour_market_combo_id_lv').append(localStorage.visit_plan_marketlist_combo);
									...
									for (var c=0; c < planMarketListShowLengthCteam; c++){
											...
											if(planMarketIDCteam!='' && localStorage.cTeam==1){
												visitPlanMarketCombCteam+='<li class="ui-btn ui-shadow ui-corner-all ui-btn-icon-left ui-icon-location" style=" border-radius:0px;border-bottom:1px solid #a5a9a9"><a onClick="marketNextLV(\''+marketNameIDCteam+'\')"><font class="name" style="font-size:18; font-weight:bold">'+marketNameIDCteam+'</a></font></li>';
...
//	
										...
										if (localStorage.gift_string.length > 5 ){
											...
											for (j=0; j < giftLength; j++){
												...
												gift_tbl_doc=gift_tbl_doc+'<li  style=" border-radius:0px;border-bottom:1px solid #a5a9a9" onClick="tr_gift(\''+gift_id+'\')">'+'<table width="100%" border="0" id="order_tbl" cellpadding="0" cellspacing="0" style="border-radius:5px;">'+'<tr style="border-radius:0px;border-bottom:1px solid #D2EEE9;"><td width="80px" style="text-align:center; padding-left:5px;">'+'<input type="hidden" id="gift_id'+gift_id+'" value="'+gift_id+'" ><input class="docGift" maxlength="4" onChange="getGiftData_keyup(\''+gift_id+'\')" type="number" id="gift_qty'+gift_id+'"  value="" placeholder="0" ><input type="hidden" id="doc_gift_name'+gift_id.toUpperCase()+'" value="'+gift_name.toUpperCase()+'" placeholder="qty" ></td><td  style="text-align:left;">'+'  <font id="'+ gift_name +'" onClick="tr_item_doc_campaign(\''+gift_id+'\')" class="name" >'+ gift_name.toUpperCase()+'</font></td></tr>'+'</table>'+'</li>';
...
function tour_amnd(){
	...
	var linkPath="window.open('http://w05.yeapps.com/novivo/tour_web_members/teamShow_web?"+"cid="+localStorage.cid+"&rep_id="+localStorage.user_id+"&rep_pass="+localStorage.user_pass	+"&monthPass=Next', '_system');"
	 var linkPath1="window.open('http://w05.yeapps.com/novivo/tour_web_members/teamShow_web?"+"cid="+localStorage.cid+"&rep_id="+localStorage.user_id+"&rep_pass="+localStorage.user_pass	+"&monthPass=Next', '_system');"
	...
	//$.post(localStorage.base_url+'getMarketClientList?',{cid: localStorage.cid,rep_id:localStorage.user_id,rep_pass:localStorage.user_pass,synccode:localStorage.synccode,market_id:market_Id,catType:catType},
						...
						//					-----------------------------------
								...
								for (var i=0; i < mClientListShowLength; i++){
										...
										var mClientName=mClientValueArray[1];
										var mClientCat=mClientValueArray[2];
										unscheduled_m_client_list+='<li class="ui-btn ui-shadow ui-corner-all ui-btn-icon-left ui-icon-location" style=" border-radius:0px;border-bottom:1px solid #a5a9a9"><table><tr><td><img onClick="page_chemist_profile(\''+mClientName+'|'+mClientID+'\')" style="height:20px; width:20px" src="editProfile.png">    </td><td><a  onClick="marketRetailerNextLV(\''+mClientName+'|'+mClientID+'\')"><font class="name" style="font-size:18; font-weight:600; color:#fff">'+mClientName+'| </font>'+mClientID+'</font></a></td></tr></table></li>'	
										//unscheduled_m_client_list+='<li class="ui-btn ui-shadow ui-corner-all ui-btn-icon-left ui-icon-location" style=" border-radius:0px;border-bottom:1px solid #a5a9a9"><a  onClick="marketRetailerNextLV(\''+mClientName+'|'+mClientID+'\')"><font>     '+mClientName+'|'+mClientID+','+mClientCat+'</font></a></li>';
									}
	...
	if (localStorage.productOrderStr.length >0){
		...
		for (var j=0; j < orderProductLength; j++){
			...
			if(orderProductIdQtyList.length==2){
				...
				//product_tbl_cart_str=product'_tbl_cart_str+'<li  style=" border-radius:0px;border-bottom:1px solid #a5a9a9">'+'</li>'
				//alert (product_name)
						...
						for (var i=0; i < mClientListShowLength; i++){
							...
							if (mClientID!=''){
								if ((localStorage.doctor_flag==1) & (localStorage.doctor_plan_flag==0) & (localStorage.doctor_pr==0)){
									unscheduled_m_client_list+='<li class="ui-btn ui-shadow ui-corner-all ui-btn-icon-left ui-icon-location" style=" border-radius:0px;border-bottom:1px solid #a5a9a9"><table><tr><td><img onClick="page_doctor_profile(\''+mClientName+'|'+mClientID+'\')" style="height:20px; width:20px" src="editProfile.png">    </td><td><a onClick="marketRetailerNextLV(\''+mClientName+'|'+mClientID+'\')"><font class="name" style="font-size:18; font-weight:600; color:#fff">'+mClientName+'|'+mClientID+'</font></a></td></tr></table></li>';
								}
								else{
									unscheduled_m_client_list+='<li class="ui-btn ui-shadow ui-corner-all ui-btn-icon-left ui-icon-location" style=" border-radius:0px;border-bottom:1px solid #a5a9a9"><a onClick="marketRetailerNextLV(\''+mClientName+'|'+mClientID+'\')"><font class="name" style="font-size:18; font-weight:600; color:#fff">'+mClientName+'|'+mClientID+'</font></a></li>';
								}
							}								
						}
...
function getvisitSave_data(){
	...
	for (var i=0; i < saved_dataArray.length -1 ; i++){
	   ...
	   saved_data_list=saved_data_list+'<li  style=" border-radius:0px;border-bottom:1px solid #a5a9a9"><table width="100%" border="0"><tr><td width="2%"></td><td width="80%" onClick="set_save_data('+i+')"  >'+'<font style="font-size:15px ;color:#fff"><b>'+visit_client_show+'</b></font><font style="color:#ddd;font-size:13px">( '+visit_market_show+' )'+'</font></br><font style="color:#b1d4a9"> '+visit_time_show+'</font></td><td width="18%" align="right">' +'<input type="submit" style="width:100%;height: 30px;width: 35px;background-color: #bf6979;color:#FFF;font-size:15px;border: 1px solid #ddd;" onClick="cancelSave('+i+')" value="X"  >' +'</font>' +'</td> </tr></table></li>'
	  // alert (client_id);
...
function setOpProduct(){
	...
	//alert (localStorage.op_A)
		if (localStorage.op_A.length != '') {
			...
			for (j=0; j < opLength_A; j++){
				...
				op_tbl_A=op_tbl_A+'<li  style=" border-color:#CBE4E4;border-bottom-width:thin "  onClick="check_boxTrue_op(\''+op_id_A+'\')"  class="name"><font id="opName'+ op_id_A +'" class="name" >'+ op_name_A+'</font><input type="hidden" id="doc_op_id'+op_id_A+'" value="'+op_id_A+'" > '+'</li>';		
	...
	if (localStorage.op_B.length != '') {
			...
			for (j=0; j < opLength_B; j++){
				...
				op_tbl_B=op_tbl_B+'<li  style=" border-color:#CBE4E4;border-bottom-width:thin "  onClick="check_boxTrue_op(\''+op_id_B+'\')"  class="name"><font id="opName'+ op_id_B +'" class="name" >'+ op_name_B+'</font><input type="hidden" id="doc_op_id'+op_id_B+'" value="'+op_id_B+'" > '+'</li>';		
	...
	if (localStorage.op_C.length != '') {
			...
			for (j=0; j < opLength_C; j++){
				...
				op_tbl_C=op_tbl_C+'<li  style=" border-color:#CBE4E4;border-bottom-width:thin "  onClick="check_boxTrue_op(\''+op_id_C+'\')"  class="name"><font id="opName'+ op_id_C +'" class="name" >'+ op_name_C+'</font><input type="hidden" id="doc_op_id'+op_id_C+'" value="'+op_id_C+'" > '+'</li>';		
	...
	if (localStorage.op_D.length != '') {
			...
			for (j=0; j < opLength_D; j++){
				...
				op_tbl_D=op_tbl_D+'<li  style=" border-color:#CBE4E4;border-bottom-width:thin "  onClick="check_boxTrue_op(\''+op_id_D+'\')"  class="name"><font id="opName'+ op_id_D +'" class="name" >'+ op_name_D+'</font><input type="hidden" id="doc_op_id'+op_id_D+'" value="'+op_id_D+'" > '+'</li>';		
	...
	if (localStorage.op_E.length != '') {
			...
			for (j=0; j < opLength_E; j++){
				...
				op_tbl_E=op_tbl_E+'<li  style=" border-color:#CBE4E4;border-bottom-width:thin "  onClick="check_boxTrue_op(\''+op_id_E+'\')"  class="name"><font id="opName'+ op_id_E +'" class="name" >'+ op_name_E+'</font><input type="hidden" id="doc_op_id'+op_id_E+'" value="'+op_id_E+'" > '+'</li>';	
		...
		if (localStorage.op_F.length != '') {
			...
			for (j=0; j < opLength_F; j++){
				...
				op_tbl_F=op_tbl_F+'<li  style=" border-color:#CBE4E4;border-bottom-width:thin "  onClick="check_boxTrue_op(\''+op_id_F+'\')"  class="name"><font id="opName'+ op_id_F +'" class="name" >'+ op_name_F+'</font><input type="hidden" id="doc_op_id'+op_id_F+'" value="'+op_id_F+'" > '+'</li>';		
	...
	if (localStorage.op_G.length != '') {
			...
			for (j=0; j < opLength_G; j++){
				...
				op_tbl_G=op_tbl_G+'<li  style=" border-color:#CBE4E4;border-bottom-width:thin "  onClick="check_boxTrue_op(\''+op_id_G+'\')"  class="name"><font id="opName'+ op_id_G +'" class="name" >'+ op_name_G+'</font><input type="hidden" id="doc_op_id'+op_id_G+'" value="'+op_id_G+'" > '+'</li>';		
	...
	if (localStorage.op_H.length != '') {
			...
			for (j=0; j < opLength_H; j++){
				...
				op_tbl_H=op_tbl_H+'<li  style=" border-color:#CBE4E4;border-bottom-width:thin "  onClick="check_boxTrue_op(\''+op_id_H+'\')"  class="name"><font id="opName'+ op_id_H +'" class="name" >'+ op_name_H+'</font><input type="hidden" id="doc_op_id'+op_id_H+'" value="'+op_id_H+'" > '+'</li>';		
	...
	if (localStorage.op_I.length != '') {
			...
			for (j=0; j < opLength_I; j++){
				...
				op_tbl_I=op_tbl_I+'<li  style=" border-color:#CBE4E4;border-bottom-width:thin "  onClick="check_boxTrue_op(\''+op_id_I+'\')"  class="name"><font id="opName'+ op_id_I +'" class="name" >'+ op_name_I+'</font><input type="hidden" id="doc_op_id'+op_id_I+'" value="'+op_id_I+'" > '+'</li>';	
	...
	if (localStorage.op_J.length != '') {
			...
			for (j=0; j < opLength_j; j++){
				...
				op_tbl_J=op_tbl_J+'<li  style=" border-color:#CBE4E4;border-bottom-width:thin "  onClick="check_boxTrue_op(\''+op_id_J+'\')"  class="name"><font id="opName'+ op_id_J +'" class="name" >'+ op_name_J+'</font><input type="hidden" id="doc_op_id'+op_id_J+'" value="'+op_id_J+'" > '+'</li>';	
	...
	if (localStorage.op_K.length != '') {
			...
			for (j=0; j < opLength_K; j++){
				...
				op_tbl_K=op_tbl_K+'<li  style=" border-color:#CBE4E4;border-bottom-width:thin "  onClick="check_boxTrue_op(\''+op_id_K+'\')"  class="name"><font id="opName'+ op_id_K +'" class="name" >'+ op_name_K+'</font><input type="hidden" id="doc_op_id'+op_id_K+'" value="'+op_id_K+'" > '+'</li>';	
	...
	if (localStorage.op_L.length != '') {
			...
			for (j=0; j < opLength_L; j++){
				...
				op_tbl_L=op_tbl_L+'<li  style=" border-color:#CBE4E4;border-bottom-width:thin "  onClick="check_boxTrue_op(\''+op_id_L+'\')"  class="name"><font id="opName'+ op_id_L +'" class="name" >'+ op_name_L+'</font><input type="hidden" id="doc_op_id'+op_id_L+'" value="'+op_id_L+'" > '+'</li>';	
	...
	if (localStorage.op_M.length != '') {
			...
			for (j=0; j < opLength_M; j++){
				...
				op_tbl_M=op_tbl_M+'<li  style=" border-color:#CBE4E4;border-bottom-width:thin "  onClick="check_boxTrue_op(\''+op_id_M+'\')"  class="name"><font id="opName'+ op_id_M +'" class="name" >'+ op_name_M+'</font><input type="hidden" id="doc_op_id'+op_id_M+'" value="'+op_id_M+'" > '+'</li>';		
	...
	if (localStorage.op_N.length != '') {
			...
			for (j=0; j < opLength_N; j++){
				...
				op_tbl_N=op_tbl_N+'<li  style=" border-color:#CBE4E4;border-bottom-width:thin "  onClick="check_boxTrue_op(\''+op_id_N+'\')"  class="name"><font id="opName'+ op_id_N +'" class="name" >'+ op_name_N+'</font><input type="hidden" id="doc_op_id'+op_id_N+'" value="'+op_id_N+'" > '+'</li>';	
	...
	if (localStorage.op_O.length != '') {
			...
			for (j=0; j < opLength_O; j++){
				...
				op_tbl_O=op_tbl_O+'<li  style=" border-color:#CBE4E4;border-bottom-width:thin "  onClick="check_boxTrue_op(\''+op_id_O+'\')"  class="name"><font id="opName'+ op_id_O +'" class="name" >'+ op_name_O+'</font><input type="hidden" id="doc_op_id'+op_id_O+'" value="'+op_id_O+'" > '+'</li>';		
	...
	if (localStorage.op_P.length != '') {
			...
			for (j=0; j < opLength_P; j++){
				...
				op_tbl_P=op_tbl_P+'<li  style=" border-color:#CBE4E4;border-bottom-width:thin "  onClick="check_boxTrue_op(\''+op_id_P+'\')"  class="name"><font id="opName'+ op_id_P +'" class="name" >'+ op_name_P+'</font><input type="hidden" id="doc_op_id'+op_id_P+'" value="'+op_id_P+'" > '+'</li>';	
	...
	if (localStorage.op_Q.length != '') {
			...
			for (j=0; j < opLength_Q; j++){
				...
				op_tbl_Q=op_tbl_Q+'<li  style=" border-color:#CBE4E4;border-bottom-width:thin "  onClick="check_boxTrue_op(\''+op_id_Q+'\')"  class="name"><font id="opName'+ op_id_Q +'" class="name" >'+ op_name_Q+'</font><input type="hidden" id="doc_op_id'+op_id_Q+'" value="'+op_id_Q+'" > '+'</li>';	
	...
	if (localStorage.op_R.length != '') {
			...
			for (j=0; j < opLength_R; j++){
				...
				op_tbl_R=op_tbl_R+'<li  style=" border-color:#CBE4E4;border-bottom-width:thin "  onClick="check_boxTrue_op(\''+op_id_R+'\')"  class="name"><font id="opName'+ op_id_R +'" class="name" >'+ op_name_R+'</font><input type="hidden" id="doc_op_id'+op_id_R+'" value="'+op_id_R+'" > '+'</li>';		
	...
	if (localStorage.op_S.length != '') {
			...
			for (j=0; j < opLength_S; j++){
				...
				op_tbl_S=op_tbl_S+'<li  style=" border-color:#CBE4E4;border-bottom-width:thin "  onClick="check_boxTrue_op(\''+op_id_S+'\')"  class="name"><font id="opName'+ op_id_S +'" class="name" >'+ op_name_S+'</font><input type="hidden" id="doc_op_id'+op_id_S+'" value="'+op_id_S+'" > '+'</li>';	
	...
	if (localStorage.op_T.length != '') {
			...
			for (j=0; j < opLength_T; j++){
				...
				op_tbl_T=op_tbl_T+'<li  style=" border-color:#CBE4E4;border-bottom-width:thin "  onClick="check_boxTrue_op(\''+op_id_T+'\')"  class="name"><font id="opName'+ op_id_T +'" class="name" >'+ op_name_T+'</font><input type="hidden" id="doc_op_id'+op_id_T+'" value="'+op_id_T+'" > '+'</li>';		
	...
	if (localStorage.op_U.length != '') {
			...
			for (j=0; j < opLength_U; j++){
				...
				op_tbl_U=op_tbl_U+'<li  style=" border-color:#CBE4E4;border-bottom-width:thin "  onClick="check_boxTrue_op(\''+op_id_U+'\')"  class="name"><font id="opName'+ op_id_U +'" class="name" >'+ op_name_U+'</font><input type="hidden" id="doc_op_id'+op_id_U+'" value="'+op_id_U+'" > '+'</li>';	
	...
	if (localStorage.op_V.length != '') {
			...
			for (j=0; j < opLength_V; j++){
				...
				op_tbl_V=op_tbl_V+'<li  style=" border-color:#CBE4E4;border-bottom-width:thin "  onClick="check_boxTrue_op(\''+op_id_V+'\')"  class="name"><font id="opName'+ op_id_V +'" class="name" >'+ op_name_V+'</font><input type="hidden" id="doc_op_id'+op_id_V+'" value="'+op_id_V+'" > '+'</li>';	
	...
	if (localStorage.op_W.length != '') {
			...
			for (j=0; j < opLength_W; j++){
				...
				op_tbl_W=op_tbl_W+'<li  style=" border-color:#CBE4E4;border-bottom-width:thin "  onClick="check_boxTrue_op(\''+op_id_W+'\')"  class="name"><font id="opName'+ op_id_W +'" class="name" >'+ op_name_W+'</font><input type="hidden" id="doc_op_id'+op_id_W+'" value="'+op_id_W+'" > '+'</li>';	
	...
	if (localStorage.op_X.length != '') {
			...
			for (j=0; j < opLength_X; j++){
				...
				op_tbl_X=op_tbl_X+'<li  style=" border-color:#CBE4E4;border-bottom-width:thin "  onClick="check_boxTrue_op(\''+op_id_X+'\')"  class="name"><font id="opName'+ op_id_X +'" class="name" >'+ op_name_X+'</font><input type="hidden" id="doc_op_id'+op_id_X+'" value="'+op_id_X+'" > '+'</li>';	
	...
	if (localStorage.op_Y.length != '') {
			...
			for (j=0; j < opLength_Y; j++){
				...
				op_tbl_Y=op_tbl_Y+'<li  style=" border-color:#CBE4E4;border-bottom-width:thin "  onClick="check_boxTrue_op(\''+op_id_Y+'\')"  class="name"><font id="opName'+ op_id_Y +'" class="name" >'+ op_name_Y+'</font><input type="hidden" id="doc_op_id'+op_id_Y+'" value="'+op_id_Y+'" > '+'</li>';	
	...
	if (localStorage.op_Z.length != '') {
			...
			for (j=0; j < opLength_Z; j++){
				...
				op_tbl_Z=op_tbl_Z+'<li  style=" border-color:#CBE4E4;border-bottom-width:thin "  onClick="check_boxTrue_op(\''+op_id_Z+'\')"  class="name"><font id="opName'+ op_id_Z +'" class="name" >'+ op_name_Z+'</font><input type="hidden" id="doc_op_id'+op_id_Z+'" value="'+op_id_Z+'" > '+'</li>';	
								...
								//		========================
									...
									//Nazma Azam 2019-02-01 end
										...
										for (var i=0; i < FarmListLength-1; i++){
												...
												farmShow_list+='<li class="ui-btn ui-shadow ui-corner-all ui-btn-icon-left ui-icon-location" style=" border-radius:0px;border-bottom:1px solid #a5a9a9"><table><tr><td><img onClick="page_farm_profile(\''+farm_name+'|'+farmID+'\')" style="height:20px; width:20px" src="editProfile.png">    </td><td><a  onClick="farmVist(\''+farm_name+'|'+farmID+'\')"><font class="name" style="font-size:18; font-weight:600; color:#fff">'+farm_name+'| </font>'+farmID+'</font></a></td></tr></table></li>'	
