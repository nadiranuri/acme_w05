...
def get_gift():  
    ...
    if not checkRep:
        ...
        get_giftStr=db((db.sm_doctor_gift.cid==cid)).select(db.sm_doctor_gift.gift_id,db.sm_doctor_gift.gift_name,orderby=db.sm_doctor_gift.gift_name)
        # return get_giftStr
...
def get_ppm():  
    ...
    if not checkRep:
        ...
        get_ppmStr=db((db.sm_doctor_ppm.cid==cid)).select(db.sm_doctor_ppm.gift_id,db.sm_doctor_ppm.gift_name,orderby=db.sm_doctor_ppm.gift_name)
        # return get_ppmStr
