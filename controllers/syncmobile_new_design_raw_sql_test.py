...
#         return sql_str
        ...
        areawise_str=""
        total_value=0
        areawise_str=areawise_str+"""<table width="100%" border="1" cellpadding="0" cellspacing="0" style="border:solid; border-style:solid; border-color:#a3ebf2; color:#fff"> 
...
#            areawise_str=areawise_str+'Route: '+str(records_ov[db.sm_order.area_name])+'('+str(records_ov[db.sm_order.area_id])+') --'+str(records_ov[db.sm_order.price.sum()])+'</br>'
            ...
            areawise_str=areawise_str+'<td align="left">'+str(records_ov_dict["area_name"])+'</td>'
                
            areawise_str=areawise_str+'<td align="left">'+str(records_ov_dict["area_name"])+'</td>'
            areawise_str=areawise_str+'<td align="center">'+str(records_ov_dict["totalprice"])+'</td>' 
            
            areawise_str=areawise_str+'</tr>'

        areawise_str=areawise_str+'</table>'
...
#        return sql_str
        ...
        for i in range(len(records_ov)): 
            ...
            areawise_str=areawise_str+'<td align="left">'+str(records_ov_dict["area_name"])+'</td>'                
            areawise_str=areawise_str+'<td align="left">'+str(records_ov_dict["area_name"])+'</td>'
            areawise_str=areawise_str+'<td align="left">'+str(records_ov_dict["totalprice"])+'</td>'             
            areawise_str=areawise_str+'</tr>'
        areawise_str=areawise_str+'</tr></table>'
...
def salsCall_order_smry():
    ...
    if (user_type=='REP'):
        ...
        report_str=report_str+"""<table width="100%" border="1" cellpadding="0" cellspacing="0" style="border:solid; border-style:solid; border-color:#0CF; color:#fff"> 
                                ...
                                <td width="10%" align="center"  >Invoice Count</td>
                                <td width="10%" align="right"  >Invoice Amount</td>
                                </tr>"""
        gtotalprice=0.0
        gintotalprice=0.0
        for i in range(len(records_ov)): 
            ...
            qset_invoice_str="SELECT count(sl) as inv_count FROM sm_invoice_head WHERE cid =  '"+ str(cid) +"' AND status = 'Invoiced' AND area_id = '"+str(area_id)+"' AND  order_datetime>='"+str(date_from)+"' AND  order_datetime<='"+str(date_to)+"'"
            ...
            qset_inv_amount="SELECT SUM((sm_invoice.price) * ( sm_invoice.quantity ) ) AS inv_totalprice FROM sm_invoice WHERE cid =  '"+ str(cid) +"' AND status = 'Invoiced'  AND area_id = '"+str(area_id)+"'  AND order_datetime>='"+str(date_from)+"' AND  order_datetime<='"+str(date_to)+"'"
            ...
            for reportRow_inv_amount in reportRow_inv_amount:
                ...
                if ((invoice_totalprice=='None') | (invoice_totalprice==None)):
                        invoice_totalprice='0'
                        gintotalprice='0'
            pass
            ...
            report_str=report_str+'<td align="center">'+str(invoice_count)+'</td>'
            report_str=report_str+'<td align="right">'+str(invoice_totalprice)+'</td>'
        ...
        report_str=report_str+'<tr><td colspan="3" align="right">Total Amount</td><td colspan="1" align="right">'+str(gtotalprice).split('.')[0]+'</td><td></td><td align="right" >'+str(gintotalprice).split('.')[0]+'</td></tr>'
        ...
        report_str=report_str+'<tr> <td colspan="6" align="right" style="padding:5px 0"><a onClick="'+linkPath+'" target="_blank" style="width: 50px;height: auto;padding: 5px 14px;background: #7a828e;">More</a></td></tr></table>'  
    ...
    if (user_type=='SUP'):
        ...
        for i in range(len(records_ov)): 
            ...
            if (level=='level0'):
                level_id=str(records_ov_dict["level0_id"])   
                level_idName=str(records_ov_dict["level0_id"])+'|'+  str(records_ov_dict["level0_name"])    

                totalprice=int(round(records_ov_dict["totalprice"]))   

                qset_vc_str="SELECT count(sl) as Vcount FROM sm_order_head WHERE cid =  '"+ str(cid) +"' AND order_date =  '"+ str(date_from)  +"' AND level0_id = '"+str(level_id)+"'" 
                reportRows_count=db.executesql(qset_vc_str,as_dict = True)
                ...
                qset_oc_str="SELECT count(sl) as Ocount FROM sm_order_head WHERE cid =  '"+ str(cid) +"' AND field1 = 'ORDER' AND order_date =  '"+ str(date_from)  +"' AND level0_id = '"+str(level_id)+"'" 
                ...
                qset_invoice_str="SELECT count(sl) as inv_count FROM sm_invoice_head WHERE cid =  '"+ str(cid) +"' AND status = 'Invoiced' AND level0_id = '"+str(level_id)+"' AND  order_datetime>='"+str(date_from)+"' AND  order_datetime<='"+str(date_to)+"'"
                reportRows_invoice_count=db.executesql(qset_invoice_str,as_dict = True)
                invoice_count=0
                for reportRows_invoice_count in reportRows_invoice_count:
                    invoice_count=reportRows_invoice_count['inv_count']
                ...
                qset_inv_amount="SELECT SUM((sm_invoice.price) * ( sm_invoice.quantity ) ) AS inv_totalprice FROM sm_invoice WHERE cid =  '"+ str(cid) +"' AND status = 'Invoiced'  AND level0_id = '"+str(level_id)+"'  AND  order_datetime>='"+str(date_from)+"' AND  order_datetime<='"+str(date_to)+"' " 
                reportRow_inv_amount=db.executesql(qset_inv_amount,as_dict = True)
            ...
            if (level=='level1'):
                ...
                qset_vc_str="SELECT count(sl) as Vcount FROM sm_order_head WHERE cid =  '"+ str(cid) +"' AND order_date =  '"+ str(date_from)  +"' AND level1_id = '"+str(level_id)+"'" 
                reportRows_count=db.executesql(qset_vc_str,as_dict = True)
                ...
                qset_oc_str="SELECT count(sl) as Ocount FROM sm_order_head WHERE cid =  '"+ str(cid) +"' AND field1 = 'ORDER' AND order_date =  '"+ str(date_from)  +"' AND level1_id = '"+str(level_id)+"'" 
                ...
                qset_invoice_str="SELECT count(sl) as inv_count FROM sm_invoice_head WHERE cid =  '"+ str(cid) +"' AND status = 'Invoiced' AND level1_id = '"+str(level_id)+"' AND  order_datetime>='"+str(date_from)+"' AND  order_datetime<='"+str(date_to)+"'"
                reportRows_invoice_count=db.executesql(qset_invoice_str,as_dict = True)
                ...
                qset_inv_amount="SELECT SUM((sm_invoice.price) * ( sm_invoice.quantity ) ) AS inv_totalprice FROM sm_invoice WHERE cid =  '"+ str(cid) +"' AND status = 'Invoiced'  AND level1_id = '"+str(level_id)+"'  AND  order_datetime>='"+str(date_from)+"' AND  order_datetime<='"+str(date_to)+"' " 
                reportRow_inv_amount=db.executesql(qset_inv_amount,as_dict = True)
            ...
            if (level=='level2'):
                ...
                qset_vc_str="SELECT count(sl) as Vcount FROM sm_order_head WHERE cid =  '"+ str(cid) +"' AND order_date =  '"+ str(date_from)  +"' AND level2_id = '"+str(level_id)+"' " 
                reportRows_count=db.executesql(qset_vc_str,as_dict = True)
                visit_count=0
                for reportRows_count in reportRows_count:
                    visit_count=reportRows_count['Vcount']

                qset_oc_str="SELECT count(sl) as Ocount FROM sm_order_head WHERE cid =  '"+ str(cid) +"' AND field1 = 'ORDER' AND order_date =  '"+ str(date_from)  +"' AND level2_id = '"+str(level_id)+"'" 
                reportRows_order_count=db.executesql(qset_oc_str,as_dict = True)
                ...
                qset_invoice_str="SELECT count(sl) as inv_count FROM sm_invoice_head WHERE cid =  '"+ str(cid) +"' AND status = 'Invoiced' AND level2_id = '"+str(level_id)+"' AND  order_datetime>='"+str(date_from)+"' AND  order_datetime<='"+str(date_to)+"'"
                reportRows_invoice_count=db.executesql(qset_invoice_str,as_dict = True)
                ...
                qset_inv_amount="SELECT SUM((sm_invoice.price) * ( sm_invoice.quantity ) ) AS inv_totalprice FROM sm_invoice WHERE cid =  '"+ str(cid) +"' AND status = 'Invoiced'  AND level2_id = '"+str(level_id)+"'  AND  order_datetime>='"+str(date_from)+"' AND  order_datetime<='"+str(date_to)+"' " 
                reportRow_inv_amount=db.executesql(qset_inv_amount,as_dict = True)
        ...
        if (level=='level0'):
            linkPath="window.open('"+sals_rprt_more_path+"sales_report_zm_0_url?"+"cid="+cid+"&rep_id="+rep_id+"&password="+password+"&synccode="+synccode+"&se_item_report="+se_item_report+"&se_market_report="+se_market_report+"&level_id="+level_id+"&date_from="+date_from+" ', '_system');"
            pass
        ...
        report_str=report_str+'<tr> <td colspan="6" align="right" style="padding:5px 0px"><a onClick="'+linkPath+'" target="_blank" style="width: 50px;height: auto;padding: 5px 14px;background: #7a828e;">More</a></td></tr></table>'  
...
def salesRprt_doctor():
    ...
    report_url = db((db.sm_settings.cid == cid) & (db.sm_settings.s_key == 'web_report_url_dcr') ).select(db.sm_settings.s_value, limitby=(0, 1))
    ...
    if (user_type=='SUP'):   
        ...
        if (level=='level0'):
            ...
            qset = qset(db.sm_doctor_visit.level0_id.belongs(levelList))
            qset = qset((db.sm_doctor_visit.visit_date == date_from))

            records = qset.select(db.sm_doctor_visit.doc_id.count(),db.sm_doctor_visit.doc_id,db.sm_doctor_visit.rep_id,db.sm_doctor_visit.route_id,db.sm_doctor_visit.route_name,db.sm_doctor_visit.visit_date,db.sm_doctor_visit.level0_id,db.sm_doctor_visit.level0_name, orderby=db.sm_doctor_visit.level0_id, groupby=db.sm_doctor_visit.level0_id)
            return db._lastsql
        ...
        if (level=='level1'):
            ...
            records = qset.select(db.sm_doctor_visit.doc_id.count(),db.sm_doctor_visit.doc_id,db.sm_doctor_visit.rep_id,db.sm_doctor_visit.route_id,db.sm_doctor_visit.route_name,db.sm_doctor_visit.visit_date, orderby=~db.sm_doctor_visit.visit_date, groupby=db.sm_doctor_visit.level1_id)
        ...
        if (level=='level2'):
            ...
            records = qset.select(db.sm_doctor_visit.doc_id.count(),db.sm_doctor_visit.doc_id,db.sm_doctor_visit.rep_id,db.sm_doctor_visit.route_id,db.sm_doctor_visit.route_name,db.sm_doctor_visit.visit_date, orderby=~db.sm_doctor_visit.visit_date, groupby=db.sm_doctor_visit.level2_id)
            # return db._lastsql
            if records:
                for i in range(len(records)):
                    recordListStr = records[i]
        ...
        if (level=='level0'):
            ...
            # recordsCount = qsetCount.select(db.sm_doctor_visit.doc_id.count(),db.sm_doctor_visit.doc_id,db.sm_doctor_visit.rep_id,db.sm_doctor_visit.route_id,db.sm_doctor_visit.route_name,db.sm_doctor_visit.visit_date, orderby=~db.sm_doctor_visit.visit_date, groupby=db.sm_doctor_visit.level0_id)
            vChecklist=[]
            vCountList=[]
        ...
        if (level=='level1'):
            ...
            recordsCount = qsetCount.select(db.sm_doctor_visit.doc_id.count(),db.sm_doctor_visit.doc_id,db.sm_doctor_visit.rep_id,db.sm_doctor_visit.route_id,db.sm_doctor_visit.route_name,db.sm_doctor_visit.visit_date, orderby=~db.sm_doctor_visit.visit_date, groupby=db.sm_doctor_visit.level1_id)
            vChecklist=[]
            vCountList=[]
            for recordsCount in recordsCount:
                vCount=recordsCount[db.sm_doctor_visit.doc_id.count()]
        ...
        if (level=='level2'):
            ...
            recordsCount = qsetCount.select(db.sm_doctor_visit.doc_id.count(),db.sm_doctor_visit.doc_id,db.sm_doctor_visit.rep_id,db.sm_doctor_visit.route_id,db.sm_doctor_visit.route_name,db.sm_doctor_visit.visit_date, orderby=~db.sm_doctor_visit.visit_date, groupby=db.sm_doctor_visit.level2_id)
            vChecklist=[]
            vCountList=[]
            for recordsCount in recordsCount:
                vCount=recordsCount[db.sm_doctor_visit.doc_id.count()]
        ...
        for i,record in enumerate(records):
            ...
            if (level=='level0'): 
                route_id=record[(db.sm_doctor_visit.level0_id)]
                route_name=record[(db.sm_doctor_visit.level0_name)]
            else:
        ...
        if (level=='level0'):
            linkPath="window.open('"+sals_rprt_dcr_more_path+"salesDcr_report_zm_url?"+"cid="+cid+"&rep_id="+rep_id+"&password="+password+"&synccode="+synccode+"&se_item_report="+se_item_report+"&se_market_report="+se_market_report+" ', '_system');"            
            pass    
        
        if (level=='level1'):
            linkPath="window.open('"+sals_rprt_dcr_more_path+"salesDcr_report_rsm_url?"+"cid="+cid+"&rep_id="+rep_id+"&password="+password+"&synccode="+synccode+"&se_item_report="+se_item_report+"&se_market_report="+se_market_report+" ', '_system');"
            pass
...
#            return len(order_sl)
            ...
            order_string=order_string+"""<table width="100%" border="1" cellpadding="0" cellspacing="0" style="border:solid; border-style:solid; border-color:#a3ebf2; color:#fff"> 
                    <tr  class="blackCatHead"  >                        
                        <td width="5%" align="left" >Visit SL:</td>
                        <td width="10%" align="left"  >Time</td>
                        <td width="15%" align="left"  >Rep</td>
                        <td width="15%" align="left"  >Client</td>
                        <td width="15%" align="left"  >Payment Mode</td>
                        <td width="15%" align="center"  >Order Amount</td>
...
#                records_amount=qset_amount.select(db.sm_order.price.sum())
                ...
                if (str(order_vsl_past) != str(vsl)):
                    ...
                    order_string=order_string+'<tr>'  
                    order_string=order_string+'<td style="padding-left:0px;">'+str(vsl)+'</td>'
                    order_string=order_string+'<td style="padding-left:0px;">'+str(order_datetime)+'</td>'
                    order_string=order_string+'<td style="padding-left:0px;">'+str(rep_name)+' | '+str(rep_id)+'</td>'    
                    order_string=order_string+'<td style="padding-left:0px;">'+str(c_name)+' | '+str(c_id)+'</td>'    
                    order_string=order_string+'<td style="padding-left:0px;">'+str(payment_mode)+'</td>'
                    order_string=order_string+'<td style="padding-left:0px;" align="center" >'+str(order_amount)+'</td>'    

                    # order_string=order_string+ "Visit SL:"+str(vsl)+ " Time:"+str(order_datetime)+"</br>Rep: "+str(rep_name)+" ("+str(rep_id)+")</br>"+str(c_name)+" ("+str(c_id)+" )"+"</br>PaymentMode "+str(payment_mode)+"</br>Order ="+str(order_amount)+"</br>"+"</br>"
                order_vsl_past=vsl

        order_string=order_string+'</tr></table>' 
        report_string=str(report_string)+'<rd>'+'<font style=" font-size:11px"></br>'+str(order_string)+'</font>'
        # return report_string
...
# #            =============area wise Value
        ...
        areawise_str=areawise_str+"""<table width="100%" border="1" cellpadding="0" cellspacing="0" style="border:solid; border-style:solid; border-color:#a3ebf2; color:#fff"> 
                    <tr  class="blackCatHead"  >                        
                        <td width="5%" align="left" >AreaID</td>
                        <td width="10%" align="left"  >AreaName</td>
                        <td width="15%" align="left"  >TotalPrice</td>
                    </tr>"""
        for i in range(len(records_ov)): 
            records_ov_dict=records_ov[i]        
            # if (areawise_flag==0):
            ...
            areawise_str=areawise_str+'<tr>'  
            areawise_str=areawise_str+'<td style="padding-left:0px;">'+str(records_ov_dict["area_id"])+'</td>'
            areawise_str=areawise_str+'<td style="padding-left:0px;">'+str(records_ov_dict["area_name"])+'</td>'
            areawise_str=areawise_str+'<td style="padding-left:0px;">'+str(records_ov_dict["totalprice"])+'</td>'    
...
#        =============area wise
        ...
        for reportRow in reportRows:
            if (areawise_flag==0):
                ...
                areawise_str=areawise_str+"""<table width="100%" border="1" cellpadding="0" cellspacing="0" style="border:solid; border-style:solid; border-color:#a3ebf2; color:#fff"> 
                    <tr  class="blackCatHead"  >                        
                        <td width="5%" align="left" >Route</td>
                        <td width="10%" align="center"  >VisitCount</td>
                        </tr>"""
            areawise_flag=1
            areawise_str=areawise_str+"""<tr  class="blackCatHead"  >                        
                    <td width="5%" align="left" >"""+str(reportRow['route_id'])+"""|"""+str(reportRow['route_name'])+"""</td>
                    <td width="10%" align="center"  >"""+str(reportRow['vCount'])+"""</td>
                    </tr>"""
        areawise_str=areawise_str+"""</table>"""       
    ...
    # ============ 20210609  END==============
        ...
        for repRow in repRows:
            if (repwise_flag==0):
                ...
                repwise_flag=1
                repwise_str=repwise_str+"""<table width="100%" border="1" cellpadding="0" cellspacing="0" style="border:solid; border-style:solid; border-color:#a3ebf2; color:#fff"> 
                    <tr  class="blackCatHead"  >                        
                        <td width="5%" align="left" >Rep</td>
                        <td width="10%" align="center"  >VisitCount</td>
                        </tr>"""
            repwise_str=repwise_str+"""<tr  class="blackCatHead"  >                        
                <td width="5%" align="left" >"""+str(repRow['rep_id'])+"""|"""+str(repRow['rep_name'])+"""</td>
                <td width="10%" align="center"  >"""+str(repRow['vCount'])+"""</td>
                </tr>"""
        repwise_str=repwise_str+"""</table>"""  
...
#  visit Count  
    ...
    #        return att_string
        ...
        #                        return gift_string
                ...
                if (start_flag==0):                                       
                    visit_string=visit_string+"""<table width="100%" border="1" cellpadding="0" cellspacing="0" style="border:solid; border-style:solid; border-color:#a3ebf2; color:#fff"> 
                        <tr  class="blackCatHead"  >
                        
                        <td width="5%" align="center" >Visit SL:</td>
                        <td width="10%" align="center"  >Time</td>
                        <td width="15%" align="center"  >Doctor</td>
                        <td width="15%" align="center"  >Product</td>
                        <td width="15%" align="center"  >Sample</td>
                        <td width="15%" align="center"  >Gift</td>
                        <td width="15%" align="center"  >PPM</td>
                        <td width="15%" align="center"  >Feedback</td>
                        </tr>"""

                    visit_string=visit_string+'<td style="padding-left:0px;">'+str(v_id)+'</td>'
                    visit_string=visit_string+'<td style="padding-left:0px;">'+str(visit_dtime)+'</td>'
                    visit_string=visit_string+'<td style="padding-left:0px;">'+str(doc_name)+' | '+str(doc_id)+'</td>'
                    
                    visit_string=visit_string+'<td align="left">'+str(campaign_string)+'</td>'                
                    visit_string=visit_string+'<td align="left">'+str(sample_string)+'</td>'                
                    visit_string=visit_string+'<td align="left">'+str(gift_string)+'</td>'                
                    visit_string=visit_string+'<td align="left">'+str(ppm_string)+'</td>'                
                    visit_string=visit_string+'<td align="left">'+str(feedback)+'</td>'                     
                    visit_string=visit_string+'</tr>'
        ...
        for reportRow in reportRows:
            if (areawise_flag==0):
                ...
                areawise_str=areawise_str+"""<table width="100%" border="1" cellpadding="0" cellspacing="0" style="border:solid; border-style:solid; border-color:#a3ebf2; color:#fff"> 
                    <tr  class="blackCatHead"  >                        
                        <td width="5%" align="left" >Route</td>
                        <td width="10%" align="left"  >VisitCount</td>
            ...
            areawise_str=areawise_str+"""<tr  class="blackCatHead"  >                        
                        <td width="5%" align="left" >"""+str(reportRow['route_name'])+"""|"""+str(reportRow['route_id'])+"""</td>
                        <td width="10%" align="left"  >"""+str(reportRow['vCount'])+"""</td>
                       
                    <tr>"""
        areawise_str=areawise_str+"""</table></br>"""


            # str(reportRow['route_name'])+'('+str(reportRow['route_id'])+') --'+str(reportRow['vCount'])+'</br>'
...
#        RepWise=========================
        ...
        for repRow in repRows:
            if (repwise_flag==0):
                ...
                repwise_flag=1
            repwise_str=repwise_str+"""<tr  class="blackCatHead"  >                        
                        <td width="5%" align="left" >"""+str(repRow['rep_name'])+"""|"""+str(repRow['rep_id'])+"""</td>
                        <td width="10%" align="left"  >"""+str(repRow['vCount'])+"""</td>
                       
                    <tr>"""
        repwise_str=repwise_str+"""</table></br>"""
            # repwise_str=repwise_str+str(repRow['rep_name'])+'('+str(repRow['rep_id'])+') --'+str(repRow['vCount'])+'</br>'
    ...
    #        return records_detail
        ...
        #            return ppm_string
                ...
                if (start_flag==0):
                    ...
                    visit_string=visit_string+'<td align="left">'+str(feedback)+'</td>'
                    visit_string=visit_string+'</tr>'
        visit_string=visit_string+'</table>'
            # return visit_string
        report_string=str(report_string)+'<rd>'+str(visit_string)
    return 'SUCCESS<SYNCDATA>'+report_string 
...
#                 return menuStr
                ...
                checkSettings=  db((db.sm_settings.cid == cid) & (db.sm_settings.s_key == 'sales_director') & (db.sm_settings.s_value == rep_id) ).select(db.sm_settings.s_value, limitby=(0, 1))
                checkSettings_dd=  db((db.sm_settings.cid == cid) & (db.sm_settings.s_key == 'd_sales_director') & (db.sm_settings.s_value == rep_id) ).select(db.sm_settings.s_value, limitby=(0, 1))
                # return db._lastsql
                


                if checkSettings:
                    linkpathRows = db((db.sm_linkpath.cid == cid) & (db.sm_linkpath.user_type == 'sup') &  ((db.sm_linkpath.field2 != 3) & (db.sm_linkpath.field2 != 2))  & ((db.sm_linkpath.field2 == 0) | (db.sm_linkpath.field2 == 1)) ).select(db.sm_linkpath.link_name, db.sm_linkpath.link_path, db.sm_linkpath.field1,orderby=db.sm_linkpath.link_name)
                elif checkSettings_dd:
                    linkpathRows = db((db.sm_linkpath.cid == cid) & (db.sm_linkpath.user_type == 'sup') & ((db.sm_linkpath.field2 != 3) & (db.sm_linkpath.field2 != 1))  & ((db.sm_linkpath.field2 == 0) | (db.sm_linkpath.field2 == 2)) ).select(db.sm_linkpath.link_name, db.sm_linkpath.link_path, db.sm_linkpath.field1,orderby=db.sm_linkpath.link_name)

                else:
                    linkpathRows = db((db.sm_linkpath.cid == cid) & (db.sm_linkpath.user_type == 'sup') & ((db.sm_linkpath.field2 != 1) | (db.sm_linkpath.field2 != 2)) & ((db.sm_linkpath.field2 == 0) | (db.sm_linkpath.field2 == 3)) ).select(db.sm_linkpath.link_name, db.sm_linkpath.link_path, db.sm_linkpath.field1,orderby=db.sm_linkpath.link_name)
    ...
    if not compRow:
        ...
        if not repRow:
           return 'FAILED<SYNCDATA>Invalid Authorization'
            ...
            if chemistRow:  
                 db((db.sm_client_temp.cid == cid) & (db.sm_client_temp.client_id == client_id) ).update( address=Address_Line_1,area_id =route,market_id =route,vat_registration_no=RegistrationNo ,district=district,thana=thana,nid=int(NID) , owner_name=Contact_Name ,contact_no1=Contact_phone ,category_id=catID , category_name=catName,sub_category_id=subcatID ,sub_category_name=subcatName, dob=DOB ,field1=Cash_Credit ,credit_limit=int(Credit_Limit) ,status=Status,newChemist=0)
                ...
                db.sm_client_temp.insert(cid =cid,client_id=client_id ,name=ChemistName ,address=Address_Line_1,area_id =route,market_id =route,vat_registration_no=RegistrationNo ,district=district,thana=thana,nid=int(NID) , owner_name=Contact_Name ,contact_no1=Contact_phone ,category_id=catID , category_name=catName,sub_category_id=subcatID ,sub_category_name=subcatName, field1=Cash_Credit ,credit_limit=int(Credit_Limit) ,status=Status,newChemist=0)
        ...
        if not repRow:
           return 'FAILED<SYNCDATA>Invalid Authorization'
            ...
            if userType=='rep':
                ...
                chemistRows = db((db.sm_client_temp.cid == cid) & (db.sm_client_temp.status != 'REJECTED') & (db.sm_client_temp.newChemist == 0) & (db.sm_client_temp.name != 'NULL') & (db.sm_client_temp.name != 'None') & (db.sm_client_temp.name != None)).select(db.sm_client_temp.id,db.sm_client_temp.client_id,db.sm_client_temp.name, db.sm_client_temp.address, db.sm_client_temp.contact_no1,db.sm_client_temp.trade_license_no,db.sm_client_temp.vat_registration_no,db.sm_client_temp.photo,db.sm_client_temp.note,db.sm_client_temp.status, orderby=db.sm_client_temp.client_id|~db.sm_client_temp.client_id, groupby=db.sm_client_temp.client_id)
                # return doctorRows
                if not chemistRows:
                    pass
...
#                             db((db.sm_client.cid == cid) & (db.sm_client.client_id == client_id) ).update( area_id =route,name=ChemistName,address=address ,vat_registration_no=RegistrationNo ,district=district,thana=thana,nid=int(NID) , owner_name=Contact_Name ,contact_no1=Contact_phone ,category_id=catID , category_name=catName,sub_category_id=subcatID ,sub_category_name=subcatName, dob=DOB ,field1=Cash_Credit ,credit_limit=int(Credit_Limit) ,status='ACTIVE',photo=imageName,field2=NumberofDoc,note=AvgPatientPerDay,depot_id=depot_id,depot_name=depot_name,store_id=store_id,store_name=store_name)
                        ...
                        db.sm_client.insert(cid =cid,client_id=client_id ,address=address,area_id =route,market_id =route,name=ChemistName ,vat_registration_no=RegistrationNo ,district=district,thana=thana,nid=int(NID) , owner_name=Contact_Name ,contact_no1=Contact_phone ,category_id=catID , category_name=catName,sub_category_id=subcatID ,sub_category_name=subcatName ,field1=Cash_Credit ,credit_limit=int(Credit_Limit) ,status='ACTIVE',photo=imageName, field2=NumberofDoc,note=AvgPatientPerDay,depot_id=depot_id,depot_name=depot_name,store_id=store_id,store_name=store_name)
