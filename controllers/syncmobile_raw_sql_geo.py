    ...
    if not compRow:
        ...
        if not repRow:
           ...
           return retStatus
            ...
            #------ market list
            clientStr = ''
            clientRows = db((db.sm_doctor_area.cid == cid) & (db.sm_doctor_area.area_id == market_id)).select(db.sm_doctor_area.doc_id, db.sm_doctor_area.doc_name, orderby=db.sm_doctor_area.doc_name)
#            return db._lastsql
            if not clientRows:
...
#                             return 'FAILED<SYNCDATA>You have already synced. Please retry after 30 minutes.'
            ...
            s_key_list.append('GEOLOCATION')
            s_key_list.append('DOC_OFFER')
            ...
            for settingsRow in settingsRows:
                ...
                if (str(settingsRow['s_key'])== 'COLLECTION_DATE'):
                    geolocation=str(settingsRow['s_value'])
                if (str(settingsRow['s_key'])== 'DOC_OFFER'):
                    doc_offer=str(settingsRow['s_value'])
#========================PromoCombo================
...
def dmpath():
   ...
   # ====apu
    return '<start>http://w05.yeapps.com/hamdard/syncmobile_raw_sql_geo/<fd>http://i001.yeapps.com/image_hub/static/mundi_image/<fd>http://i001.yeapps.com/image_hub/mundi_image/<fd>http://w05.yeapps.com/hamdard/syncmobile_raw_sql_geo/<fd>http://w05.yeapps.com/hamdard/syncmobile_raw_sql_geo/<fd>http://w05.yeapps.com/hamdard/tour_web/<fd>http://w05.yeapps.com/hamdard/tour_web_members/<end>'
    # =====apu end
