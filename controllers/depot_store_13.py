    ...
    if btn_upload=='Upload':        
        ...
        for i in range(total_row):
            ...
            if len(coloum_list)!=3:
                ...
                #------------------
                if depot_idExcel=='' or store_idExcel=='' or store_nameExcel=='':
                ...
                if valid_depot_id==False:
                    ...
                    if existCheckRows:
                        ...
                        try:
                            db.sm_depot_store.insert(cid=c_id,depot_id=depot_idExcel,store_id=store_idExcel,store_name=store_nameExcel)
...
def depot_store_download():
    ...
    myString+='Branch ID,Branch Name,Short Name,Store ID,Store Name\n'
    ...
    for rec in records:
        ...
        myString+=str(depot_id)+','+str(depot_name)+','+str(short_name)+',`'+str(store_id)+','+str(store_name)+'\n'
