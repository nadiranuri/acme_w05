...
def leave_application_approval_d():               
    ...
    return dict(director_id=director_id,director_pass=director_pass,zonal_head_id=zonal_head_id,zonal_head_name=zonal_head_name,depthNo=depthNo,cid=cid,uid=uid,u_name=u_name,ared_head_id=ared_head_id,ared_head_name=ared_head_name,emp_id=emp_id,emp_name=emp_name,from_date=from_date,to_date=to_date,total_leave=total_leave,leave_type=leave_type)
