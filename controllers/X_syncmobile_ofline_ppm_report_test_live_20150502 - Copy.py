...
def getBaseUrl(cid):
    baseUrl = ''
    baseUrl = 'http://a002.businesssolutionapps.com/skf/';
...
def doc_add_submit():
    ...
    urlPath = getBaseUrl(cid)+'doc_add_submit?cid='+cid+'&rep_id='+rep_id+'&rep_pass='+password+'&synccode='+synccode+'&route='+route+'&routeName='+routeName+'&dName='+dName+'&dSpaciality='+dSpaciality+'&dDegree='+dDegree+'&dDOB='+dDOB+'&dMDay='+dMDay+'&dMobile='+dMobile+'&dCAddress='+dCAddress+'&dCategory='+dCategory+'&dDist='+dDist+'&dThana='+dThana
#     return urlPath
    #-----
    try:
...
def doc_list():
    ...
    password = str(request.vars.rep_pass).strip()
    synccode = str(request.vars.synccode).strip()
    route = str(request.vars.docID).strip()
    
    urlPath = getBaseUrl(cid)+'doc_list?cid='+cid+'&rep_id='+rep_id+'&rep_pass='+password+'&synccode='+synccode+'&route='+route
#     return urlPath
    #-----
    try:
        result = fetch(urlPath)
...
def doc_info_confirm():
    ...
    urlPath = getBaseUrl(cid)+'cancelDoc?cid='+cid+'&rep_id='+rep_id+'&rep_pass='+password+'&synccode='+synccode+'&docID='+docID
#     return urlPath
    #-----
    try:
        result = fetch(urlPath)
