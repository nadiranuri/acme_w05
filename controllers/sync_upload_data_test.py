...
#                 return ProductID
        ...
        #                 Insert
                    db.sm_item.insert(cid=cid, item_id=str(ProductID).strip().upper(), name=str(ProductName).strip().upper(), category_id='DEFAULT', price=float(UnitPrice), dist_price=float(UnitPrice), unit_type=Unit)
