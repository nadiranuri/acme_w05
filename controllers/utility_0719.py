...
#            return db._lastsql
            if not repRow:
                ...
                returnStr = 'User ID: ' + str(fieldForceId) + ', Password: ' + str(randNumber)  + '  Download Link:  http://im-gp.com/d/skf '
...
#http://127.0.0.1:8000/skf/utility/clean_depot_data?depotid=170&password=admin123abcMrepPharma
#http://c003.cloudapp.net/skf/utility/clean_depot_data?depotid=170&password=admin123abcMrepPharma
