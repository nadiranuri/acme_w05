...
def level_batch_upload():
    ...
    if (uploadDepth=='' or uploadDepth==None):
        ...
        redirect (URL(c='utility_mrep',f='utility_settings'))
...
#        depot_list_exist=depotRows.as_list()
        ...
        for i in range(total_row):
            ...
            if len(coloum_list)==5:
                ...
                level_Name_excel=check_special_char(str(coloum_list[1]).strip().upper())
                plevel_ID_excel=check_special_char_id(str(coloum_list[2]).strip().upper())
                territory_des_excel=check_special_char(str(coloum_list[3]).strip())
                special_territory_excel=check_special_char_id(str(coloum_list[4]).strip().upper())
                        ...
                        #------------------------------ Depth 1 
                            ...
                            if not level_rows:
                                ...
                                if parent_rows:
                                    ...
                                    db.sm_level.insert(cid=c_id,level_id=level_ID_excel,level_name=level_Name_excel,parent_level_id=plevel_ID_excel,parent_level_name=level0_name,is_leaf=isLeaf,depot_id=depotIdvalue,depth=uploadDepth,level0=level0,level0_name=level0_name,level1=level_ID_excel,level1_name=level_Name_excel,territory_des=territory_des_excel,special_territory_code=special_territory_excel)         
                                    count_inserted+=1
                                    continue
                        ...
                        #------------------------------ Depth 2 
                            ...
                            if not level_rows:
                                ...
                                if parent_rows:
                                    ...
                                    db.sm_level.insert(cid=c_id,level_id=level_ID_excel,level_name=level_Name_excel,parent_level_id=plevel_ID_excel,parent_level_name=level1_name,is_leaf=isLeaf,depot_id=depotIdvalue,depth=uploadDepth,level0=level0,level0_name=level0_name,level1=level1,level1_name=level1_name,level2=level_ID_excel,level2_name=level_Name_excel,territory_des=territory_des_excel,special_territory_code=special_territory_excel)         
                                    count_inserted+=1
                                    continue
                        ...
                        #------------------------------ Depth 3 
                            ...
                            if not level_rows:
                                ...
                                if parent_rows:
                                    ...
                                    db.sm_level.insert(cid=c_id,level_id=level_ID_excel,level_name=level_Name_excel,parent_level_id=plevel_ID_excel,parent_level_name=level2_name,is_leaf=isLeaf,depot_id=depotIdvalue,depth=uploadDepth,level0=level0,level0_name=level0_name,level1=level1,level1_name=level1_name,level2=level2,level2_name=level2_name,level3=level_ID_excel,level3_name=level_Name_excel,territory_des=territory_des_excel,special_territory_code=special_territory_excel)         
                                    count_inserted+=1
                                    continue
                        ...
                        #------------------------------ Depth 5 
                            ...
                            if not level_rows:
                                ...
                                if parent_rows:
                                    ...
                                    db.sm_level.insert(cid=c_id,level_id=level_ID_excel,level_name=level_Name_excel,parent_level_id=plevel_ID_excel,parent_level_name=level4_name,is_leaf=isLeaf,depot_id=depotIdvalue,depth=uploadDepth,level0=level0,level0_name=level0_name,level1=level1,level1_name=level1_name,level2=level2,level2_name=level2_name,level3=level3,level3_name=level3_name,level4=level4,level4_name=level4_name,level5=level_ID_excel,level5_name=level_Name_excel,territory_des=territory_des_excel,special_territory_code=special_territory_excel)         
                                    count_inserted+=1
                                    continue
                        ...
                        #------------------------------ Depth 6 
                            ...
                            if not level_rows:
                                ...
                                if parent_rows:
                                    ...
                                    db.sm_level.insert(cid=c_id,level_id=level_ID_excel,level_name=level_Name_excel,parent_level_id=plevel_ID_excel,parent_level_name=level5_name,is_leaf=isLeaf,depot_id=depotIdvalue,depth=uploadDepth,level0=level0,level0_name=level0_name,level1=level1,level1_name=level1_name,level2=level2,level2_name=level2_name,level3=level3,level3_name=level3_name,level4=level4,level4_name=level4_name,level5=level5,level5_name=level5_name,level6=level_ID_excel,level6_name=level_Name_excel,territory_des=territory_des_excel,special_territory_code=special_territory_excel)         
                                    count_inserted+=1
                                    continue
                        ...
                        #------------------------------ Depth 7
                            ...
                            if not level_rows:
                                ...
                                if parent_rows:
                                    ...
                                    db.sm_level.insert(cid=c_id,level_id=level_ID_excel,level_name=level_Name_excel,parent_level_id=plevel_ID_excel,parent_level_name=level6_name,is_leaf=isLeaf,depot_id=depotIdvalue,depth=uploadDepth,level0=level0,level0_name=level0_name,level1=level1,level1_name=level1_name,level2=level2,level2_name=level2_name,level3=level3,level3_name=level3_name,level4=level4,level4_name=level4_name,level5=level5,level5_name=level5_name,level6=level6,level6_name=level6_name,level7=level_ID_excel,level7_name=level_Name_excel,territory_des=territory_des_excel,special_territory_code=special_territory_excel)         
                                    count_inserted+=1
                                    continue
                                else:
                                    error_data=row_data+'(Invalid Patent ID)\n'
...
def download_area_team():
    ...
    myString+='Month,ZoneID,ZoneName,RegionID,RegionName,AreaID,AreaName,TerritoryID,TerritoryName,TerritoryDescription,SpecialTerritoryCode,ZM ID,ZM Name,ZM Mobile,RSM ID,RSM Name,RSM Mobile,FM ID,FM Name,FM Mobile,MSO ID,MSO Name,MSO Mobile,MSO Category,Status,AreaFlag,TeamFlag,Note\n'
    for rec in records:
        ...
        first_part_flag=str(rec.first_part_flag)
        status=str(rec.second_part_flag)
        note=str(rec.des).replace(',', ';')
        ...
        zm_id+','+zm_name+','+zm_mobile_no+','+rsm_id+','+rsm_name+','+rsm_mobile_no+','+fm_id+','+fm_name+','+fm_mobile_no+','+mso_id+','+mso_name+','+mso_mobile_no+','+mso_category+','+status+','+first_part_flag+','+status+','+note+'\n'
...
def backup_team_structure(firstDate,schedule_date):
    ...
    records=db((db.temp_sm_level.cid==c_id)&(db.temp_sm_level.is_leaf=='1')&(db.temp_sm_rep_area.cid==c_id)&(db.temp_sm_level.level_id==db.temp_sm_rep_area.area_id)&(db.temp_sm_rep.cid==c_id)&(db.temp_sm_rep.rep_id==db.temp_sm_rep_area.rep_id)).select(db.temp_sm_level.ALL,db.temp_sm_rep_area.rep_id,db.temp_sm_rep.name,db.temp_sm_rep.mobile_no,db.temp_sm_rep_area.rep_category,orderby=db.temp_sm_rep_area.rep_category|db.temp_sm_rep_area.rep_id|db.temp_sm_level.level_id)
    supervisorRows=db((db.temp_sm_rep.cid==c_id)&(db.temp_sm_rep.user_type=='sup')&(db.temp_sm_supervisor_level.cid==c_id)&(db.temp_sm_rep.rep_id==db.temp_sm_supervisor_level.sup_id)).select(db.temp_sm_supervisor_level.level_id,db.temp_sm_rep.rep_id,db.temp_sm_rep.name,db.temp_sm_rep.mobile_no,orderby=db.temp_sm_rep.rep_id)
    
    #---------    
    structureList=[]
    dictData={}
    for rec in records:        
        zone_id=str(rec.temp_sm_level.level0).strip()
        zone_name=str(rec.temp_sm_level.level0_name).replace(',', ' ')
        region_id=str(rec.temp_sm_level.level1).strip()
        region_name=str(rec.temp_sm_level.level1_name).replace(',', ' ')
        area_id=str(rec.temp_sm_level.level2).strip()
        area_name=str(rec.temp_sm_level.level2_name).replace(',', ' ')
        territory_id=str(rec.temp_sm_level.level_id).strip()
        territory_name=str(rec.temp_sm_level.level_name).replace(',', ' ')
        territory_des=str(rec.temp_sm_level.territory_des).replace(',', ' ')
        special_territory_code=str(rec.temp_sm_level.special_territory_code)
        
        mso_id=str(rec.temp_sm_rep_area.rep_id).strip()
        mso_name=str(rec.temp_sm_rep.name).strip()
        mso_mobile_no=str(rec.temp_sm_rep.mobile_no).strip()
        mso_category=str(rec.temp_sm_rep_area.rep_category).strip()
                
        zm_id=''
        zm_name=''
        zm_mobile_no=''        
        for row0 in supervisorRows:
            sup_level_id=str(row0.temp_sm_supervisor_level.level_id).strip()
            sup_id=str(row0.temp_sm_rep.rep_id)
            sup_name=str(row0.temp_sm_rep.name)
            sup_mobile_no=str(row0.temp_sm_rep.mobile_no)        
        ...
        for row1 in supervisorRows:
            sup_level_id=str(row1.temp_sm_supervisor_level.level_id).strip()
            sup_id=str(row1.temp_sm_rep.rep_id)
            sup_name=str(row1.temp_sm_rep.name)
            sup_mobile_no=str(row1.temp_sm_rep.mobile_no)          
        ...
        for row2 in supervisorRows:
            sup_level_id=str(row2.temp_sm_supervisor_level.level_id).strip()
            sup_id=str(row2.temp_sm_rep.rep_id)
            sup_name=str(row2.temp_sm_rep.name)
            sup_mobile_no=str(row2.temp_sm_rep.mobile_no)        
...
#             else:
    ...
    #--------------------- Year-month delete
    yearMonthRecords=db((db.sm_area_team_process_schedule.cid==c_id)&(db.sm_area_team_process_schedule.status=='1')&(db.sm_area_team_process_schedule.field2==0)).select(db.sm_area_team_process_schedule.ALL,orderby=~db.sm_area_team_process_schedule.first_date)
    ...
    #--------------------- Year-month
    ymProcessRecords=db((db.sm_area_team_process_schedule.cid==c_id)&(db.sm_area_team_process_schedule.status=='1')&(db.sm_area_team_process_schedule.field2==0)).select(db.sm_area_team_process_schedule.ALL,orderby=~db.sm_area_team_process_schedule.first_date,limitby=(0,1))
    
    #--------------------- Year-month
    rollbackRecords=db((db.sm_area_team_process_schedule.cid==c_id)&(db.sm_area_team_process_schedule.field2==0)).select(db.sm_area_team_process_schedule.ALL,orderby=~db.sm_area_team_process_schedule.first_date,limitby=(0,1))
    
    #--------------------- Year-month
    ymConfirmRecords=db((db.sm_area_team_process_schedule.cid==c_id)&(db.sm_area_team_process_schedule.status=='1')&(db.sm_area_team_process_schedule.field2==1)).select(db.sm_area_team_process_schedule.ALL,orderby=~db.sm_area_team_process_schedule.first_date,limitby=(0,1))
    
    
    #---------------------------
    return dict(search_form=search_form,records=records,yearMonthRecords=yearMonthRecords,rollbackRecords=rollbackRecords,ymConfirmRecords=ymConfirmRecords,ymProcessRecords=ymProcessRecords,pendingRecords=pendingRecords,page=page,items_per_page=items_per_page,access_permission=access_permission)
...
def process_area_team_manual_step1():
    ...
    if not processRecords:
        ...
        #--------- current 4 tables data clean  
        db.temp_sm_level.truncate()
        db.temp_sm_rep.truncate()
        db.temp_sm_rep_area.truncate()
        db.temp_sm_supervisor_level.truncate()
        ...
        for zoneRecord in zoneRecords:
            ...
            errorFlag=False
            errorMsg=''
            levelIdRow=db((db.temp_sm_level.cid==c_id)&(db.temp_sm_level.level_id==setLevelId)).select(db.temp_sm_level.level_id,limitby=(0,1))
            if levelIdRow:
                errorFlag=True
                errorMsg='Zone ID already exist'
            else:
                levelNameRow=db((db.temp_sm_level.cid==c_id)&(db.temp_sm_level.level_name.upper()==zone_name)).select(db.temp_sm_level.level_id,limitby=(0,1))
                if levelNameRow:
                    errorFlag=True
            ...
            if errorFlag==True:
                ...
                db.temp_sm_level.insert(cid=c_id,level_id=setLevelId,level_name=zone_name,parent_level_id='0',parent_level_name='',is_leaf=isLeaf,depot_id='',depth=depthNo,level0=level0,level0_name=level0_name)
        ...
        for regionRecord in regionRecords:
            ...
            if levelIdRow:
                ...
                levelNameRow=db((db.temp_sm_level.cid==c_id)&(db.temp_sm_level.level_name.upper()==region_name)).select(db.temp_sm_level.level_id,limitby=(0,1))
                if levelNameRow:
                    errorFlag=True
            ...
            if errorFlag==True:
                ...
                db.temp_sm_level.insert(cid=c_id,level_id=setLevelId,level_name=region_name,parent_level_id=zone_id,parent_level_name=zone_name,is_leaf=isLeaf,depot_id='',depth=depthNo,level0=level0,level0_name=level0_name,level1=level1,level1_name=level1_name)
        ...
        for areaRecord in areaRecords:
            ...
            if levelIdRow:
                ...
                levelNameRow=db((db.temp_sm_level.cid==c_id)&(db.temp_sm_level.level_name.upper()==area_name)).select(db.temp_sm_level.level_id,limitby=(0,1))
                if levelNameRow:
                    errorFlag=True
            ...
            if errorFlag==True:
                ...
                db.temp_sm_level.insert(cid=c_id,level_id=setLevelId,level_name=area_name,parent_level_id=region_id,parent_level_name=region_name,is_leaf=isLeaf,depot_id='',depth=depthNo,level0=level0,level0_name=level0_name,level1=level1,level1_name=level1_name,level2=level2,level2_name=level2_name)
        ...
        for territoryRecord in territoryRecords:
            ...
            if levelIdRow:
                ...
                levelNameRow=db((db.temp_sm_level.cid==c_id)&(db.temp_sm_level.level_name.upper()==territory_name)).select(db.temp_sm_level.level_id,limitby=(0,1))
                if levelNameRow:
                    errorFlag=True
    ...
    if not processRecords:
        ...
        for zmRecord in zmRecords:
            ...
            if not(zm_id=='' or zm_name==''):    
                ffLevelRow1=db((db.temp_sm_supervisor_level.cid==c_id)&(db.temp_sm_supervisor_level.sup_id==zm_id)).select(db.temp_sm_supervisor_level.level_depth_no,limitby=(0,1))
                if ffLevelRow1:
            ...
            if errorFlag==True:
                ...
                #---- Supervisor
                if not (zm_id=='' or zm_name==''):       
                    ffRow=db((db.temp_sm_rep.cid==c_id)&(db.temp_sm_rep.rep_id==zm_id)).select(db.temp_sm_rep.rep_id,limitby=(0,1))
                    if not ffRow:                
                        if mobile_no==0:
                            status='INACTIVE'
                        else:
                        ...
                        db.temp_sm_rep.insert(cid=c_id,rep_id=zm_id,name=zm_name,mobile_no=mobile_no,password=randNumber,status=status,user_type='sup')
                
                    #---- Supervisor-Level
                    ffLevelRow2=db((db.temp_sm_supervisor_level.cid==c_id)&(db.temp_sm_supervisor_level.sup_id==zm_id)&(db.temp_sm_supervisor_level.level_id==zone_id)).select(db.temp_sm_supervisor_level.sup_id,limitby=(0,1))
                    if not ffLevelRow2:
                        db.temp_sm_supervisor_level.insert(cid=c_id,sup_id=zm_id,sup_name=zm_name,level_id=zone_id,level_name=zone_name,level_depth_no=depthNo)
        ...
        for rsmRecord in rsmRecords:
            ...
            if not (rsm_id=='' or rsm_name==''):
                ffLevelRow1=db((db.temp_sm_supervisor_level.cid==c_id)&(db.temp_sm_supervisor_level.sup_id==rsm_id)).select(db.temp_sm_supervisor_level.level_depth_no,limitby=(0,1))
                if ffLevelRow1:
                    level_depth_no=ffLevelRow1[0].level_depth_no
                    if level_depth_no!=depthNo:
                        errorFlag=True
            ...
            if errorFlag==True:
                ...
                #---- Supervisor
                if not (rsm_id=='' or rsm_name==''):         
                    ffRow=db((db.temp_sm_rep.cid==c_id)&(db.temp_sm_rep.rep_id==rsm_id)).select(db.temp_sm_rep.rep_id,limitby=(0,1))
                    if not ffRow:                
                        if mobile_no==0:
                            status='INACTIVE'
                        else:
                        ...
                        db.temp_sm_rep.insert(cid=c_id,rep_id=rsm_id,name=rsm_name,mobile_no=mobile_no,password=randNumber,status=status,user_type='sup')
                
                    #---- Supervisor-Level                
                    ffLevelRow2=db((db.temp_sm_supervisor_level.cid==c_id)&(db.temp_sm_supervisor_level.sup_id==rsm_id)&(db.temp_sm_supervisor_level.level_id==region_id)).select(db.temp_sm_supervisor_level.sup_id,limitby=(0,1))
                    if not ffLevelRow2:
                        db.temp_sm_supervisor_level.insert(cid=c_id,sup_id=rsm_id,sup_name=rsm_name,level_id=region_id,level_name=region_name,level_depth_no=depthNo)
        ...
        for fmRecord in fmRecords:
            ...
            if not(fm_id=='' or fm_name==''):
                ffLevelRow1=db((db.temp_sm_supervisor_level.cid==c_id)&(db.temp_sm_supervisor_level.sup_id==fm_id)).select(db.temp_sm_supervisor_level.level_depth_no,limitby=(0,1))
                if ffLevelRow1:
                    level_depth_no=ffLevelRow1[0].level_depth_no
                    if level_depth_no!=depthNo:
                        errorFlag=True
            ...
            if errorFlag==True:                
                ...
                #---- Supervisor
                if not(fm_id=='' or fm_name==''):
                    ffRow=db((db.temp_sm_rep.cid==c_id)&(db.temp_sm_rep.rep_id==fm_id)).select(db.temp_sm_rep.rep_id,limitby=(0,1))
                    if not ffRow:                
                        if mobile_no==0:
                            status='INACTIVE'
                        else:
                        ...
                        db.temp_sm_rep.insert(cid=c_id,rep_id=fm_id,name=fm_name,mobile_no=mobile_no,password=randNumber,status=status,user_type='sup')
                
                    #---- Supervisor-Level                
                    ffLevelRow2=db((db.temp_sm_supervisor_level.cid==c_id)&(db.temp_sm_supervisor_level.sup_id==fm_id)&(db.temp_sm_supervisor_level.level_id==area_id)).select(db.temp_sm_supervisor_level.sup_id,limitby=(0,1))
                    if not ffLevelRow2:
                        db.temp_sm_supervisor_level.insert(cid=c_id,sup_id=fm_id,sup_name=fm_name,level_id=area_id,level_name=area_name,level_depth_no=depthNo)
        ...
        if not msoRecords:
            ...
            for msoRecord in msoRecords:
                ...
                if errorFlag==True:                
                    ...
                    #---- Rep
                    ffRow=''
                    ffRow=db((db.temp_sm_rep.cid==c_id)&(db.temp_sm_rep.rep_id==mso_id)).select(db.temp_sm_rep.rep_id,limitby=(0,1))
                    if not ffRow:                
                        if mobile_no==0:
                            status='INACTIVE'
                        else:
                        ...
                        db.temp_sm_rep.insert(cid=c_id,rep_id=mso_id,name=mso_name,mobile_no=mobile_no,password=randNumber,status=status,user_type='rep')
                        
                    #---- Rep-Route
                    validDataFlag=True
                    if mso_category in ['A','B','Z']:
                        ffLevelRow2=''
                        ffLevelRow2=db((db.temp_sm_rep_area.cid==c_id)&(db.temp_sm_rep_area.rep_id==mso_id)&(db.temp_sm_rep_area.area_id==territory_id)).select(db.temp_sm_rep_area.rep_category,limitby=(0,1))
                        if not ffLevelRow2:
                            db.temp_sm_rep_area.insert(cid=c_id,rep_id=mso_id,rep_name=mso_name,area_id=territory_id,area_name=territory_name,rep_category=mso_category)
                        else:
                        ...
                        for specialTerrRow in specialTerrRows:
                            ...
                            ffLevelRow2=''
                            ffLevelRow2=db((db.temp_sm_rep_area.cid==c_id)&(db.temp_sm_rep_area.rep_id==mso_id)&(db.temp_sm_rep_area.area_id==territoryId)).select(db.temp_sm_rep_area.rep_id,limitby=(0,1))
                            if not ffLevelRow2:
                                db.temp_sm_rep_area.insert(cid=c_id,rep_id=mso_id,rep_name=mso_name,area_id=territoryId,area_name=territoryName,rep_category=mso_category)
                                validDataFlag=True
                            else:
                                continue
...
def process_area_team_manual_step4():
    ...
    if not processRecords:
        ...
        #--------- current 4 tables data copy and backup to backup table        
        
        #repSql="Update  sm_rep a, sm_rep_backup b set a.password=b.password,a.sync_code=b.sync_code,a.sync_code_servey=b.sync_code_servey,a.sync_count=b.sync_count,a.first_sync_date=b.first_sync_date,a.last_sync_date=b.last_sync_date,a.monthly_sms_count=b.monthly_sms_count,a.monthly_voucher_count=b.monthly_voucher_count,a.level_id=b.level_id,a.depot_id=b.depot_id,a.sync_req_time=b.sync_req_time,a.sync_flag=b.sync_flag,a.sync_data=b.sync_data Where a.status='ACTIVE' and a.rep_id=b.rep_id;"
        #db.executesql(repSql)
...
#manual
#http://127.0.0.1:8000/mrepskf/level/process_area_team_manual_main?process_date=2016-02-06
def process_area_team_manual_step1_main():
    c_id=session.cid
    ...
    if not processRecords:
        ...
        #---------previous backup data clean         
        db.sm_level_backup.truncate()
        db.sm_rep_backup.truncate()
        db.sm_rep_area_backup.truncate()
        db.sm_supervisor_level_backup.truncate()
        
        #--------- current 4 tables data copy and backup to backup table        
        levelSql="INSERT INTO  sm_level_backup SELECT * FROM  sm_level;"
        repSql="INSERT INTO  sm_rep_backup SELECT * FROM  sm_rep;"
        repAreaSql="INSERT INTO  sm_rep_area_backup SELECT * FROM  sm_rep_area;"
        supLevelSql="INSERT INTO  sm_supervisor_level_backup SELECT * FROM  sm_supervisor_level;"
        
        db.executesql(levelSql)
        db.executesql(repSql)
        db.executesql(repAreaSql)
        db.executesql(supLevelSql)
        time.sleep(1)
...
def process_area_team_manual_step2_main():
    c_id=session.cid
...
def process_area_team_manual_step3_main():
    c_id=session.cid
...
def process_area_team_manual_step4_main():
    c_id=session.cid
...
def download_level_classic_check():
    task_id='rm_workingarea_manage'
    task_id_view='rm_workingarea_view'
    access_permission=check_role(task_id)
    access_permission_view=check_role(task_id_view)
    ...
    records=''
    myString='Area Structure\n\n'
    myString+=session.level0Name+' Name,'+session.level0Name+' ID,'+session.level1Name+' Name,'+session.level1Name+' Code,'+session.level2Name+' Name,'+session.level2Name+' Code,'+session.level3Name+' Name,'+session.level3Name +' Code, Description,Special Territory Code\n'
    
    
    max = db.temp_sm_level.depth.max()
    maxDepth = db(db.temp_sm_level.cid==c_id).select(max).first()[max]
    
    
    levelList=[]
    levelRecords=db(db.temp_sm_level.cid==c_id).select(db.temp_sm_level.ALL,orderby=db.temp_sm_level.level_name)
    levelList=levelRecords.as_list()
    
    records1=db((db.temp_sm_level.cid==c_id)&(db.temp_sm_level.parent_level_id=='0')).select(db.temp_sm_level.ALL,orderby=db.temp_sm_level.level_name)
    for row1 in records1:
        level_id_1=row1.level_id
        level_name_1=row1.level_name
    ...
    import gluon.contenttype
    response.headers['Content-Type'] = gluon.contenttype.contenttype('.csv')
    response.headers['Content-disposition'] = 'attachment; filename=download_working_area_classic_check.csv'   
    return str(myString)


#============================================== Download
def download_representative_check():
    c_id=session.cid
    ...
    qset=db()
    qset=qset(db.temp_sm_rep.cid==c_id)
    qset=qset(db.temp_sm_rep.user_type=='rep')
    
    #------------
    records=qset.select(db.temp_sm_rep.ALL,orderby=db.temp_sm_rep.name)
    ...
    import gluon.contenttype
    response.headers['Content-Type'] = gluon.contenttype.contenttype('.csv')
    response.headers['Content-disposition'] = 'attachment; filename=download_representative_check.csv'   
    return str(myString)

#------------------ 
def download_rep_area_check():
    c_id=session.cid
    ...
    qset=db()
    qset=qset(db.temp_sm_rep_area.cid==c_id)   
    records=qset.select(db.temp_sm_rep_area.ALL,orderby=db.temp_sm_rep_area.rep_name|db.temp_sm_rep_area.area_name)
    ...
    import gluon.contenttype
    response.headers['Content-Type'] = gluon.contenttype.contenttype('.csv')
    response.headers['Content-disposition'] = 'attachment; filename=download_rep_area_check.csv'   
    return str(myString)


#------------------ 
def download_supervisor_check():
    c_id=session.cid
...
#   ---------------------
    ...
    qset=db()
    qset=qset(db.temp_sm_rep.cid==c_id)
    qset=qset(db.temp_sm_rep.user_type=='sup')
    ...
    import gluon.contenttype
    response.headers['Content-Type'] = gluon.contenttype.contenttype('.csv')
    response.headers['Content-disposition'] = 'attachment; filename=download_supervisor_check.csv'   
    return str(myString)

#===================================

#------------------ 
def download_supervisor_level_check():
    c_id=session.cid    
    task_id='rm_workingarea_manage'
    task_id_view='rm_workingarea_view'
    access_permission=check_role(task_id)
    ...
    qset=db()
    qset=qset(db.temp_sm_supervisor_level.cid==c_id)   
    
    records=qset.select(db.temp_sm_supervisor_level.ALL,orderby=db.temp_sm_supervisor_level.sup_name|db.temp_sm_supervisor_level.level_name)
    ...
    import gluon.contenttype
    response.headers['Content-Type'] = gluon.contenttype.contenttype('.csv')
    response.headers['Content-disposition'] = 'attachment; filename=download_supervisor_level_check.csv'   
    return str(myString)
    
#------------------ 
def download_duplicate_mobile_check():
    c_id=session.cid
    #Check access permission
       #----------Task assaign----------
    task_id='rm_workingarea_manage'
    ...
    duplicateMobSql="select rep_id,name,mobile_no,user_type from sm_rep a where a.mobile_no IN(select mobile_no from (SELECT mobile_no,count(mobile_no) as mobCount FROM `temp_sm_rep` where mobile_no!=0 group by `mobile_no`) b where b.mobCount>1)"
    userList=db.executesql(duplicateMobSql,as_dict = True) 
    
    #REmove , from record.Cause , means new column in excel
    myString='Duplicate Mobile User List\n'
    myString+='User ID,Name,Mobile,User Type\n'
    
    for i in range(len(userList)):
        dictData=userList[i]
        
        rep_id=dictData['rep_id']
        rep_name=str(dictData['name']).replace(',', ' ')
        mobile_no=dictData['mobile_no']
        user_type=dictData['user_type']
        
        myString+=str(rep_id)+','+str(rep_name)+','+str(mobile_no)+','+str(user_type)+'\n'
        
    #Save as csv
    import gluon.contenttype
    response.headers['Content-Type'] = gluon.contenttype.contenttype('.csv')
    response.headers['Content-disposition'] = 'attachment; filename=download_duplicateMobile_check.csv'   
    return str(myString)


#========================== Processed data transfer to Production table
def confirm_area_team_process():
    c_id=session.cid
    ...
    dateFlag=True
    try:
        first_date=datetime.datetime.strptime(str(firstDate),'%Y-%m-%d').strftime('%Y-%m-%d')
    except:
        #return 'Invalid request'
        session.flash='Invalid Year-Month!'
        dateFlag=False
    ...
    #----------------------------------
    if dateFlag==True:
        processRecords=db((db.sm_area_team_process_schedule.cid==c_id)&(db.sm_area_team_process_schedule.first_date==first_date)&(db.sm_area_team_process_schedule.status=='1')&(db.sm_area_team_process_schedule.field2==0)).select(db.sm_area_team_process_schedule.ALL,orderby=~db.sm_area_team_process_schedule.first_date,limitby=(0,1))
        if not processRecords:
            #return 'Process Not available'
            session.flash='Process Not available!'
        else:
            check_confirm=request.vars.check_confirm
            if (check_confirm!='YES'):
                session.flash='Please check confirmaion!'
            else:     
                schedule_date=processRecords[0].schedule_date        
                processRecords[0].update_record(field2=2) #Running...
                
                #============= previous backup data clean         
                db.backup_sm_level.truncate()
                db.backup_sm_rep.truncate()
                db.backup_sm_rep_area.truncate()
                db.backup_sm_supervisor_level.truncate()
                
                #--------- current 4 tables data copy and backup to backup table        
                levelSql="INSERT INTO  backup_sm_level SELECT * FROM  sm_level;"
                repSql="INSERT INTO  backup_sm_rep SELECT * FROM  sm_rep;"
                repAreaSql="INSERT INTO  backup_sm_rep_area SELECT * FROM  sm_rep_area;"
                supLevelSql="INSERT INTO  backup_sm_supervisor_level SELECT * FROM  sm_supervisor_level;"
                ...
                #update rep sync information into temp_rep from backup
                repUpdateSql="Update  temp_sm_rep a, backup_sm_rep b set a.password=b.password,a.sync_code=b.sync_code,a.sync_code_servey=b.sync_code_servey,a.sync_count=b.sync_count,a.first_sync_date=b.first_sync_date,a.last_sync_date=b.last_sync_date,a.monthly_sms_count=b.monthly_sms_count,a.monthly_voucher_count=b.monthly_voucher_count,a.level_id=b.level_id,a.depot_id=b.depot_id,a.sync_req_time=b.sync_req_time,a.sync_flag=b.sync_flag,a.sync_data=b.sync_data Where a.status='ACTIVE' and a.rep_id=b.rep_id;"
                db.executesql(repUpdateSql)
                
                time.sleep(1)
                
                #====================== Production 4 tables data clean  
                db.sm_level.truncate()
                db.sm_rep.truncate()
                db.sm_rep_area.truncate()
                db.sm_supervisor_level.truncate()
                
                #--------- set production table data from temp table     
                levelSqlFinal="INSERT INTO  sm_level SELECT * FROM  temp_sm_level;"
                repSqlFinal="INSERT INTO  sm_rep SELECT * FROM  temp_sm_rep;"
                repAreaSqlFinal="INSERT INTO  sm_rep_area SELECT * FROM  temp_sm_rep_area;"
                supLevelSqlFinal="INSERT INTO  sm_supervisor_level SELECT * FROM  temp_sm_supervisor_level;"
                 
                db.executesql(levelSqlFinal)
                db.executesql(repSqlFinal)
                db.executesql(repAreaSqlFinal)
                db.executesql(supLevelSqlFinal)
                
                #------------
                processRecords[0].update_record(field2=1)
                session.flash='Process confirmed successfully!'
                db.commit()
                
    redirect(URL('area_team_process_home'))
    
    #return 'Process confirmed successfully'

def confirm_area_team_process_rollback():
    c_id=session.cid
    ...
    #----------------------------------
    if dateFlag==True:
        processRecords=db((db.sm_area_team_process_schedule.cid==c_id)&(db.sm_area_team_process_schedule.first_date==first_date)&(db.sm_area_team_process_schedule.status=='1')&(db.sm_area_team_process_schedule.field2==1)).select(db.sm_area_team_process_schedule.ALL,orderby=~db.sm_area_team_process_schedule.first_date,limitby=(0,1))
        if not processRecords:
            #return 'Process Not available'
            session.flash='Confirm Process Not available!'
        else:
            check_confirm=request.vars.check_confirm
            if (check_confirm!='YES'):
                session.flash='Please check confirmaion!'
                ...
                #--------- set production table data from temp table     
                levelSqlFinal="INSERT INTO  sm_level SELECT * FROM  backup_sm_level;"
                repSqlFinal="INSERT INTO  sm_rep SELECT * FROM  backup_sm_rep;"
                repAreaSqlFinal="INSERT INTO  sm_rep_area SELECT * FROM  backup_sm_rep_area;"
                supLevelSqlFinal="INSERT INTO  sm_supervisor_level SELECT * FROM  backup_sm_supervisor_level;"
                ...
                #------------
                processRecords[0].update_record(field2=0)
