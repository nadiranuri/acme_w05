...
def prescription_details():
    ...
    if pr_deletebtn:
        ...
        if pr_delete=='yes': 
            headRow = db((db.sm_prescription_seen_head.cid == c_id) & (db.sm_prescription_seen_head.id == rowid)).delete()
            detailRow = db((db.sm_prescription_seen_details.cid == c_id) & (db.sm_prescription_seen_details.id == rowid)).delete()
