...
#     Flat rate==================
    ...
    productStr = ''
    productRows = db((db.sm_item.cid == cid) & (db.sm_item.status == 'ACTIVE')).select(db.sm_item.item_id, db.sm_item.name, db.sm_item.price, db.sm_item.vat_amt, orderby=db.sm_item.name)
