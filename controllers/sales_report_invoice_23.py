...
def sales_report_rsm():
    ...
    if (user_type=='SUP'):
        ...
        if session.btn_filter: 
            ...
            recordsInvcAmount = qstInvcAmnt.select(((db.sm_invoice.price)*(db.sm_invoice.quantity)).sum(),db.sm_invoice.level2_id,db.sm_invoice.order_datetime, orderby=db.sm_invoice.level0_name, groupby=db.sm_invoice.level2_id)
