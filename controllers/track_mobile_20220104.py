            ...
            if user_type=='sup':
                ...
                if not supLevelRows:
                    ...
                    if level_depth_no==0:
                        ...
                        supRows=db( (db.sm_supervisor_level.cid==c_id) & (db.sm_supervisor_level.sup_id!='6878')& (db.sm_supervisor_level.sup_id!='6908')& (db.sm_supervisor_level.sup_id!='6909')& (db.sm_supervisor_level.sup_id!='3605') & (db.sm_supervisor_level.level_id.belongs(level1_list) & (db.sm_supervisor_level.level_depth_no=='0'))).select(db.sm_supervisor_level.sup_id,db.sm_supervisor_level.sup_name,db.sm_supervisor_level.level_id,db.sm_supervisor_level.level_name,db.sm_supervisor_level.level_depth_no,orderby=db.sm_supervisor_level.level_depth_no|db.sm_supervisor_level.sup_name)
                        # return supRows
                        for row in supRows:
