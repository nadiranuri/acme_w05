...
#             step_Rows_2 = db((db.sm_supervisor_level.cid == cid)  &  (db.sm_supervisor_level.level_id.belongs(areaList) )).select(db.sm_supervisor_level.sup_id, db.sm_supervisor_level.sup_name, orderby=db.sm_supervisor_level.sup_id)
#             return step_Rows_2
            return dict(step_Rows_2=step_Rows_2,memId_1=memId_1,memName_1=memName_1,sup_name=sup_name)
