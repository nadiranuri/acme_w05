...
#            return db._lastsql
            if not repRow:
                ...
                returnStr = 'User ID: ' + str(fieldForceId) + ', Password: ' + str(randNumber)  + '  Download Link:  http://im-gp.com/d/novivo/ '
    ...
    if btn_change_password:
        ...
        if not(c_id==''or user_id==''or old_password==''or new_password==''or confirm_password==''):
            if new_password==confirm_password:
                ...
                url = 'http://w05.yeapps.com/cpanelmrep/default/password_change?password_data='+request_text
