...
#                                     menuDivStr+="""<li ><a href="/"""+appName+"""/utility/depot_opening_balance"><div>Depot Opening</div></a></li>"""
                                ...
                                if check_role('rm_utility_manage') == True:
                                    ...
                                    menuDivStr += """<li ><a href="/""" + appName + """/client_transfer/transfer_area"><div style="color:#B30000">Transfer Client</div></a></li>"""
                                    menuDivStr += """<li ><a href="/""" + appName + """/transfer_doc_area/transfer_doc_area"><div style="color:#B30000">Transfer Doctor</div></a></li>"""
