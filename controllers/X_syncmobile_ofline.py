...
# http://127.0.0.1:8000/mrepbiopharma/syncmobile_ofline/check_user?cid=BIOPHARMA&rep_id=DKA-111&rep_pass=4256&synccode=2150
def check_user():
...
#                return db._lastsql
                ...
                dealerStr = str(depot_id) + '<fd>' + str(depotName)+'<rd>'
                ...
                regionStr='a<fd>b<rd>c<fd>d<rd>c<fd>d'
...
#     cid = str(request.vars.CID).strip().upper()
#     if (cid='BIOPHARMA'):
#          return '<start>http://127.0.0.1:8000/mrepbiopharma/syncmobile_ofline/<fd>http://127.0.0.1:8000/mrepbiopharma/static/<fd>http://127.0.0.1:8000/mrepbiopharma/syncmobile_ofline/<end>'
