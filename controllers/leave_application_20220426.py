...
def leave_application_ddmConfirmP():              
    ...
    if checkRep: 
        ...
        if btn_approve_application:                        
            ...
            statusConfirm = db((db.sm_leave_application.cid == cid)  & (db.sm_leave_application.emp_id == memId_r) & (db.sm_leave_application.id == memId_r_id) & (db.sm_leave_application.director_marktng_status == '')).update(from_date=from_dt_2,to_date=to_dt_2,total_leave=total_leave,ddm_id=director_id,ddm_status='Approved')            
            session.flash='Approved Successfully.'
        ...
        if btn_reject_application: 
            ...
            statusConfirm = db((db.sm_leave_application.cid == cid)  & (db.sm_leave_application.emp_id == memId_r)& (db.sm_leave_application.id == memId_r_id) ).update(ddm_id=director_id,ddm_status='Rejected')              
            session.flash='Rejected Successfully.'
            redirect(URL(c='leave_application',f='leave_application_approval_ddmP',vars=dict(cid=cid,director_id=director_id,director_pass=director_pass,memId_r=memId_r,memId_r_id=memId_r_id,memName_r=memName_r)))
    else:
        session.flash='Invalid Authorization.'
...
def leave_application_dConfirmP():              
    ...
    if checkRep: 
        ...
        if btn_approve_application:            
            ...
            statusConfirm = db((db.sm_leave_application.cid == cid)  & (db.sm_leave_application.emp_id == memId_r) & (db.sm_leave_application.id == memId_r_id) & (db.sm_leave_application.director_marktng_status == '')).update(from_date=from_dt_2,to_date=to_dt_2,total_leave=total_leave,director_id=director_id,director_marktng_status='Approved')            
            session.flash='Approved Successfully.'
            redirect(URL(c='leave_application',f='leave_application_approval_dp',vars=dict(cid=cid,director_id=director_id,director_pass=director_pass,memId_r=memId_r,memId_r_id=memId_r_id,memName_r=memName_r)))

            
        if btn_reject_application:            
            statusConfirm = db((db.sm_leave_application.cid == cid)  & (db.sm_leave_application.emp_id == memId_r)& (db.sm_leave_application.id == memId_r_id) ).update(director_id=director_id,director_marktng_status='Rejected')              
            session.flash='Rejected Successfully.'
