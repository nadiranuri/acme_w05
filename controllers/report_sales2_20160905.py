...
def discount_type_wise_sales_download():
    ...
    for i in range(len(recordList)):    
        ...
        str(spFlatDiscRate)+','+str(spApprovedDiscRate)+','+str(spOthersDiscRate)+','+str(noDiscRate)+','+str(invTpAmt)+','+str(invDiscAmtRD)+','+str(spFlatDiscAmtSP)+','+str(spApprovedDiscAmtSP)+','+str(spOthersDiscAmtSP)+','+str(invDiscAmt)+','+str(no_disc_tp)+','+str(invVatAmt)+','+str(invNetAmt)+','+str(retTpAmt)+','+str(ret_DiscAmt)+','+str(ret_sp_flat)+','+str(ret_sp_approved)+','+str(ret_sp_others)+','+str(retDiscAmt)+','+str(ret_no_disc_tp)+','+str(retVatAmt)+','+str(retNetAmt)+','+str(netTp)+','+str(net_DiscAmt)+','+str(net_sp_flat)+','+str(net_sp_approved)+','+str(net_sp_others)+','+str(netDisc)+','+str(net_no_disc_tp)+','+str(netVat)+','+str(netGrandAmt)+'\n'
        
    myString+=str(invocieCount)+' Invoice(s),Total,,,,,,,,,,'+str(round(invTpTotal,2))+',,,,,'+str(round(invDiscTotal,2))+',,'+str(round(invVatTotal,2))+','+str(round(invNetTotal,2))+','+str(round(retTpTotal,2))+',,,,,'+str(round(retDiscTotal,2))+',,'+str(round(retVatTotal,2))+','+str(round(retNetTotal,2))+','+str(round(netTpTotal,2))+','+str(round(net_DiscAmtTotal,2))+','+str(round(net_sp_flatTotal,2))+','+str(round(net_sp_approvedTotal,2))+','+str(round(net_sp_othersTotal,2))+','+str(round(netDiscTotal,2))+','+str(round(net_no_disc_tpTotal,2))+','+str(round(netVatTotal,2))+','+str(round(netGrandTotal,2))+'\n'
...
def discount_type_wise_sales_ad_download():
    ...
    for i in range(len(recordList)):    
        ...
        #------------------------        
        myString+=str(invoice_date)+','+str(invSl)+','+str(client_id)+','+str(client_name)+','+str(area_id)+','+str(market_name)+','+str(discount_precentRD)+','+\
        str(spFlatDiscRate)+','+str(spApprovedDiscRate)+','+str(spOthersDiscRate)+','+str(noDiscRate)+','+str(netTp)+','+str(net_DiscAmt)+','+str(net_sp_flat)+','+str(net_sp_approved)+','+str(net_sp_others)+','+str(netDisc)+','+str(net_no_disc_tp)+','+str(netVat)+','+str(netGrandAmt)+'\n'
