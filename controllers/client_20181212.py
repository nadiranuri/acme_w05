...
def client_batch_upload():
    ...
    if btn_upload=='Upload':        
        ...
        existLevelRows=db((db.sm_level.cid==c_id)&(db.sm_level.is_leaf==1)&(db.sm_level.level_name.belongs(area_list_excel))).select(db.sm_level.level_id,db.sm_level.level_name,orderby=db.sm_level.level_id)
