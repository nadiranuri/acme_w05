...
def salesDcr_report_detail():
    ...
    if (user_type=='REP'):
        ...
        condition=""      
        condition="and s1.route_id IN ("+str(repAreaStr)+")"  


        condition2=""       
        condition2="and s2.route_id IN ("+str(repAreaStr)+")" 
        # return  condition2
...
#         return db._lastsql
        ...
        condition=""      
        condition="and s1."+str(level)+" IN ("+str(levelStr)+")"  



        condition2=""       
        condition2="and s2."+str(level)+" IN ("+str(levelStr)+")"  
    ...
    return dict(date_to=date_to,cid=cid,rep_id=rep_id,password=password,synccode=synccode,records_ov=records_ov,search_form=search_form)
